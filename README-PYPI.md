...
More detail: [`examples/example_onprem_list_sources.py`](https://github.com/criblio/cribl_control_plane_sdk_python/blob/master/./examples/example_onprem_list_sources.py).
