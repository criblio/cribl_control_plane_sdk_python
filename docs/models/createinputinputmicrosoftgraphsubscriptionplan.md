...
```python
from cribl_control_plane.models import CreateInputInputMicrosoftGraphSubscriptionPlan

value = CreateInputInputMicrosoftGraphSubscriptionPlan.ENTERPRISE_GCC
