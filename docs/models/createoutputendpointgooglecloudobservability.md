...
```python
from cribl_control_plane.models import CreateOutputEndpointGoogleCloudObservability

value = CreateOutputEndpointGoogleCloudObservability.TELEMETRY_GOOGLEAPIS_COM_443
