...
```python
from cribl_control_plane.models import CreateOutputOutputGoogleBigqueryGoogleAuthenticationMethod

value = CreateOutputOutputGoogleBigqueryGoogleAuthenticationMethod.AUTO
