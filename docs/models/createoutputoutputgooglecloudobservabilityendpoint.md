...
```python
from cribl_control_plane.models import CreateOutputOutputGoogleCloudObservabilityEndpoint

value = CreateOutputOutputGoogleCloudObservabilityEndpoint.TELEMETRY_GOOGLEAPIS_COM_443
