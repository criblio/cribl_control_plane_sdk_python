...
```python
from cribl_control_plane.models import CreateOutputOutputLocalSearchStorageFormat

value = CreateOutputOutputLocalSearchStorageFormat.JSON_COMPACT_EACH_ROW_WITH_NAMES
