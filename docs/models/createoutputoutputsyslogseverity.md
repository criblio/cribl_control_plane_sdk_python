# CreateOutputOutputSyslogSeverity
...
```python
from cribl_control_plane.models import CreateOutputOutputSyslogSeverity

value = CreateOutputOutputSyslogSeverity.EMERGENCY
