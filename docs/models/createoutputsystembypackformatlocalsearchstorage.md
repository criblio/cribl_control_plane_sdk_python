...
```python
from cribl_control_plane.models import CreateOutputSystemByPackFormatLocalSearchStorage

value = CreateOutputSystemByPackFormatLocalSearchStorage.JSON_COMPACT_EACH_ROW_WITH_NAMES
