...
```python
from cribl_control_plane.models import CreateOutputSystemByPackGoogleAuthenticationMethod

value = CreateOutputSystemByPackGoogleAuthenticationMethod.AUTO
