...
```python
from cribl_control_plane.models import CreateOutputSystemByPackGoogleAuthenticationMethodGoogleCloudObservability

value = CreateOutputSystemByPackGoogleAuthenticationMethodGoogleCloudObservability.AUTO
