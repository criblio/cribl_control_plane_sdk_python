...
```python
from cribl_control_plane.models import CreateOutputSystemByPackOutputGoogleCloudObservabilityEndpoint

value = CreateOutputSystemByPackOutputGoogleCloudObservabilityEndpoint.TELEMETRY_GOOGLEAPIS_COM_443
