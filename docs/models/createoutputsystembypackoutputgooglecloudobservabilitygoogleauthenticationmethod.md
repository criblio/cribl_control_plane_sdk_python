...
```python
from cribl_control_plane.models import CreateOutputSystemByPackOutputGoogleCloudObservabilityGoogleAuthenticationMethod

value = CreateOutputSystemByPackOutputGoogleCloudObservabilityGoogleAuthenticationMethod.AUTO
