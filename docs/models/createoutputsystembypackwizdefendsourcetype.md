# CreateOutputSystemByPackWizDefendSourceType
...
```python
from cribl_control_plane.models import CreateOutputSystemByPackWizDefendSourceType

value = CreateOutputSystemByPackWizDefendSourceType.AWS_CLOUDTRAIL
