# CreateOutputWizDefendSourceType
...
```python
from cribl_control_plane.models import CreateOutputWizDefendSourceType

value = CreateOutputWizDefendSourceType.AWS_CLOUDTRAIL
