...
Executor configuration, including the executor type and its settings.
...
| `conf`                                                                 | Dict[str, *Any*]                                                       | :heavy_minus_sign:                                                     | Executor-type-specific settings object. Shape varies by executor type. |