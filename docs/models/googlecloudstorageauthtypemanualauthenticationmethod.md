...
```python
from cribl_control_plane.models import GoogleCloudStorageAuthTypeManualAuthenticationMethod

value = GoogleCloudStorageAuthTypeManualAuthenticationMethod.AUTO
