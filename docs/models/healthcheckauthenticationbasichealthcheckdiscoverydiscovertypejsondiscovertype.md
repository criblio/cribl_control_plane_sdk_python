...
```python
from cribl_control_plane.models import HealthCheckAuthenticationBasicHealthCheckDiscoveryDiscoverTypeJSONDiscoverType

value = HealthCheckAuthenticationBasicHealthCheckDiscoveryDiscoverTypeJSONDiscoverType.HTTP
