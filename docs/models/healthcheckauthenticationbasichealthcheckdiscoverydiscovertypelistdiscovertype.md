...
```python
from cribl_control_plane.models import HealthCheckAuthenticationBasicHealthCheckDiscoveryDiscoverTypeListDiscoverType

value = HealthCheckAuthenticationBasicHealthCheckDiscoveryDiscoverTypeListDiscoverType.HTTP
