...
```python
from cribl_control_plane.models import HealthCheckAuthenticationBasicHealthCheckDiscoveryDiscoverTypeNoneDiscoverType

value = HealthCheckAuthenticationBasicHealthCheckDiscoveryDiscoverTypeNoneDiscoverType.HTTP
