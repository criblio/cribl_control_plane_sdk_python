...
```python
from cribl_control_plane.models import HealthCheckAuthenticationBasicSecretHealthCheckDiscoveryDiscoverTypeListDiscoverType

value = HealthCheckAuthenticationBasicSecretHealthCheckDiscoveryDiscoverTypeListDiscoverType.HTTP
