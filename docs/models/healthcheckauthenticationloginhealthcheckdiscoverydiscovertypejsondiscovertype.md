...
```python
from cribl_control_plane.models import HealthCheckAuthenticationLoginHealthCheckDiscoveryDiscoverTypeJSONDiscoverType

value = HealthCheckAuthenticationLoginHealthCheckDiscoveryDiscoverTypeJSONDiscoverType.HTTP
