...
```python
from cribl_control_plane.models import HealthCheckAuthenticationLoginHealthCheckDiscoveryDiscoverTypeListDiscoverType

value = HealthCheckAuthenticationLoginHealthCheckDiscoveryDiscoverTypeListDiscoverType.HTTP
