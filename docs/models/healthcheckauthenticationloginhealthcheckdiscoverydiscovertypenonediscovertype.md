...
```python
from cribl_control_plane.models import HealthCheckAuthenticationLoginHealthCheckDiscoveryDiscoverTypeNoneDiscoverType

value = HealthCheckAuthenticationLoginHealthCheckDiscoveryDiscoverTypeNoneDiscoverType.HTTP
