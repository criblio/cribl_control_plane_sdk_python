...
```python
from cribl_control_plane.models import HealthCheckAuthenticationLoginSecretHealthCheckDiscoveryDiscoverTypeNoneDiscoverType

value = HealthCheckAuthenticationLoginSecretHealthCheckDiscoveryDiscoverTypeNoneDiscoverType.HTTP
