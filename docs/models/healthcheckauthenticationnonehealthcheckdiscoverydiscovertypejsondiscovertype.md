...
```python
from cribl_control_plane.models import HealthCheckAuthenticationNoneHealthCheckDiscoveryDiscoverTypeJSONDiscoverType

value = HealthCheckAuthenticationNoneHealthCheckDiscoveryDiscoverTypeJSONDiscoverType.HTTP
