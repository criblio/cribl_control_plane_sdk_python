...
```python
from cribl_control_plane.models import HealthCheckAuthenticationNoneHealthCheckDiscoveryDiscoverTypeListDiscoverType

value = HealthCheckAuthenticationNoneHealthCheckDiscoveryDiscoverTypeListDiscoverType.HTTP
