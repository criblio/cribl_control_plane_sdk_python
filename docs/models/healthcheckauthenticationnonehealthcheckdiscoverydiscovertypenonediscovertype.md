...
```python
from cribl_control_plane.models import HealthCheckAuthenticationNoneHealthCheckDiscoveryDiscoverTypeNoneDiscoverType

value = HealthCheckAuthenticationNoneHealthCheckDiscoveryDiscoverTypeNoneDiscoverType.HTTP
