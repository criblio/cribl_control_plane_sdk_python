...
```python
from cribl_control_plane.models import HealthCheckAuthenticationOauthHealthCheckDiscoveryDiscoverTypeJSONDiscoverType

value = HealthCheckAuthenticationOauthHealthCheckDiscoveryDiscoverTypeJSONDiscoverType.HTTP
