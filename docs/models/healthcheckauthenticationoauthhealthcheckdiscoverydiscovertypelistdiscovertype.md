...
```python
from cribl_control_plane.models import HealthCheckAuthenticationOauthHealthCheckDiscoveryDiscoverTypeListDiscoverType

value = HealthCheckAuthenticationOauthHealthCheckDiscoveryDiscoverTypeListDiscoverType.HTTP
