...
```python
from cribl_control_plane.models import HealthCheckAuthenticationOauthHealthCheckDiscoveryDiscoverTypeNoneDiscoverType

value = HealthCheckAuthenticationOauthHealthCheckDiscoveryDiscoverTypeNoneDiscoverType.HTTP
