...
```python
from cribl_control_plane.models import HealthCheckAuthenticationOauthSecretHealthCheckDiscoveryDiscoverTypeListDiscoverType

value = HealthCheckAuthenticationOauthSecretHealthCheckDiscoveryDiscoverTypeListDiscoverType.HTTP
