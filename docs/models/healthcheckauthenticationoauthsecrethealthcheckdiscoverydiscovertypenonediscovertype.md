...
```python
from cribl_control_plane.models import HealthCheckAuthenticationOauthSecretHealthCheckDiscoveryDiscoverTypeNoneDiscoverType

value = HealthCheckAuthenticationOauthSecretHealthCheckDiscoveryDiscoverTypeNoneDiscoverType.HTTP
