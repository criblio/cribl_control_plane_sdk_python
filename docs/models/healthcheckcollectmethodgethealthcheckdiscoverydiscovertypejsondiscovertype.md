...
```python
from cribl_control_plane.models import HealthCheckCollectMethodGetHealthCheckDiscoveryDiscoverTypeJSONDiscoverType

value = HealthCheckCollectMethodGetHealthCheckDiscoveryDiscoverTypeJSONDiscoverType.HTTP
