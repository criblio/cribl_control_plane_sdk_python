...
```python
from cribl_control_plane.models import HealthCheckCollectMethodGetHealthCheckDiscoveryDiscoverTypeListDiscoverType

value = HealthCheckCollectMethodGetHealthCheckDiscoveryDiscoverTypeListDiscoverType.HTTP
