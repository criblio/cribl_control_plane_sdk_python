...
```python
from cribl_control_plane.models import HealthCheckCollectMethodGetHealthCheckDiscoveryDiscoverTypeNoneDiscoverType

value = HealthCheckCollectMethodGetHealthCheckDiscoveryDiscoverTypeNoneDiscoverType.HTTP
