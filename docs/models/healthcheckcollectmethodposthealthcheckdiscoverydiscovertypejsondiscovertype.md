...
```python
from cribl_control_plane.models import HealthCheckCollectMethodPostHealthCheckDiscoveryDiscoverTypeJSONDiscoverType

value = HealthCheckCollectMethodPostHealthCheckDiscoveryDiscoverTypeJSONDiscoverType.HTTP
