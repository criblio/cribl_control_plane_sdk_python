...
```python
from cribl_control_plane.models import HealthCheckCollectMethodPostHealthCheckDiscoveryDiscoverTypeListDiscoverType

value = HealthCheckCollectMethodPostHealthCheckDiscoveryDiscoverTypeListDiscoverType.HTTP
