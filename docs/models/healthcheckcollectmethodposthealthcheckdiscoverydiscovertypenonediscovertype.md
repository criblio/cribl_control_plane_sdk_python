...
```python
from cribl_control_plane.models import HealthCheckCollectMethodPostHealthCheckDiscoveryDiscoverTypeNoneDiscoverType

value = HealthCheckCollectMethodPostHealthCheckDiscoveryDiscoverTypeNoneDiscoverType.HTTP
