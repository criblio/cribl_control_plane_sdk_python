...
```python
from cribl_control_plane.models import InputResponseInputMicrosoftGraphSubscriptionPlan

value = InputResponseInputMicrosoftGraphSubscriptionPlan.ENTERPRISE_GCC
