...
```python
from cribl_control_plane.models import OutputGoogleCloudObservabilityEndpoint

value = OutputGoogleCloudObservabilityEndpoint.TELEMETRY_GOOGLEAPIS_COM_443
