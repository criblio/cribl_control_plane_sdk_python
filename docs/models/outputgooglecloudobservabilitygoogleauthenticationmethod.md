...
```python
from cribl_control_plane.models import OutputGoogleCloudObservabilityGoogleAuthenticationMethod

value = OutputGoogleCloudObservabilityGoogleAuthenticationMethod.AUTO
