...
```python
from cribl_control_plane.models import OutputResponseEndpointGoogleCloudObservability

value = OutputResponseEndpointGoogleCloudObservability.TELEMETRY_GOOGLEAPIS_COM_443
