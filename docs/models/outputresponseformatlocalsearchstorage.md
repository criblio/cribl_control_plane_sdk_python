...
```python
from cribl_control_plane.models import OutputResponseFormatLocalSearchStorage

value = OutputResponseFormatLocalSearchStorage.JSON_COMPACT_EACH_ROW_WITH_NAMES
