...
```python
from cribl_control_plane.models import OutputResponseGoogleAuthenticationMethodGoogleCloudObservability

value = OutputResponseGoogleAuthenticationMethodGoogleCloudObservability.AUTO
