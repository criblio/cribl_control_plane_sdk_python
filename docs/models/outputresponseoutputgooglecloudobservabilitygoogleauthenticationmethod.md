...
```python
from cribl_control_plane.models import OutputResponseOutputGoogleCloudObservabilityGoogleAuthenticationMethod

value = OutputResponseOutputGoogleCloudObservabilityGoogleAuthenticationMethod.AUTO
