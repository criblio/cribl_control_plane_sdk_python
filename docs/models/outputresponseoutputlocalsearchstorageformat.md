...
```python
from cribl_control_plane.models import OutputResponseOutputLocalSearchStorageFormat

value = OutputResponseOutputLocalSearchStorageFormat.JSON_COMPACT_EACH_ROW_WITH_NAMES
