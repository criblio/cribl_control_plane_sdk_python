...
```python
from cribl_control_plane.models import OutputSentinelOneAISIEMAISIEMEndpointPath

value = OutputSentinelOneAISIEMAISIEMEndpointPath.ROOT_SERVICES_COLLECTOR_EVENT
