...
with CriblControlPlane(
    ...
    res = ccp_client.destinations.create(request={
        ...
        "retry_settings": {
            "enabled": True,
            "initial_backoff_ms": 2614.76,
            "backoff_multiplier": 6389.94,
            "max_backoff_ms": 7295.73,
            "jitter_percent": 166.54,
        },
...
with CriblControlPlane(
    ...
    res = ccp_client.destinations.update(id="<id>", output={
        ...
        "retry_settings": {
            "enabled": True,
            "initial_backoff_ms": 6434.77,
            "backoff_multiplier": 857.42,
            "max_backoff_ms": 2924.72,
            "jitter_percent": 4562.74,
        },
        "auth_type": models.AuthenticationMethodOptions.MANUAL,
