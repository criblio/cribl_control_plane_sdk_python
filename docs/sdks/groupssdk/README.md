...
with CriblControlPlane(
    ...
    res = ccp_client.groups.create(product=models.ProductsCore.EDGE, id="<id>", cloud={
        ...
        "region": "<value>",
    }, config_version="<value>", deploying_worker_count=393.49, description="ack before fondly scent because gee without where exactly", estimated_ingest_rate=models.EstimatedIngestRate.RATE60_MB_PER_SEC, git={
        "commit": "<value>",
...
with CriblControlPlane(
    ...
    res = ccp_client.groups.update(product=models.ProductsCore.STREAM, id_param="<value>", id="<id>", cloud={
        "provider": models.CloudProvider.AWS,
        "region": "<value>",
    }, config_version="<value>", deploying_worker_count=7451.49, description="verbally feminize harmful prance really", estimated_ingest_rate=models.EstimatedIngestRate.RATE156_MB_PER_SEC, git={
        "commit": "<value>",
