...
with CriblControlPlane(
    ...
    res = ccp_client.groups.create(product=models.ProductsCore.EDGE, id="<id>", cloud={
        ...
        "region": "<value>",
    }, config_version="<value>", deploying_worker_count=393.49, description="ack before fondly scent because gee without where exactly", estimated_ingest_rate=models.EstimatedIngestRate.RATE84_MB_PER_SEC, git={
        "commit": "<value>",
