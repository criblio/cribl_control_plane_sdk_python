...
with CriblControlPlane(
    ...
    res = ccp_client.groups.create(product=models.ProductsCore.EDGE, id="goatCloudIanWg", cloud={
        ...
        "<value 2>",
        "<value 3>",
    ], tags="<value>", type_=models.GroupCreateRequestType.LAKE_ACCESS, upgrade_version="<value>", worker_count=1846.59, worker_remote_access=True)
...
with CriblControlPlane(
    ...
    res = ccp_client.groups.update(product=models.ProductsCore.STREAM, id_param="<value>", id="goatCloudIanWg", cloud={
        ...
        "<value 2>",
        "<value 3>",
    ], tags="<value>", type_=models.ConfigGroupType.LAKE_ACCESS, upgrade_version="<value>", worker_count=7542.18, worker_remote_access=True)
