...
with CriblControlPlane(
    ...
    res = ccp_client.lake_datasets.list(lake_id="<id>", storage_location_id="<id>", format_="<value>", exclude_ddss="<value>", exclude_deleted="<value>", exclude_internal="<value>", exclude_byos="<value>")
