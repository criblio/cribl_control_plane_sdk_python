...
with CriblControlPlane(
    ...
    res = ccp_client.groups.mappings.create(product=models.ProductsCore.STREAM, id="os-based-mapping", conf={
        "functions": [
            {
                "id": models.ID.EVAL,
...
with CriblControlPlane(
    ...
    res = ccp_client.groups.mappings.update(product=models.ProductsCore.EDGE, id_param="<value>", id="complex-mapping", conf={
        "functions": [
            {
                "id": models.ID.EVAL,
