...
with CriblControlPlane(
    ...
    res = ccp_client.packs.destinations.statuses.get(id="<id>", pack="<value>", metrics=True, type_=False)
...
with CriblControlPlane(
    ...
    res = ccp_client.packs.destinations.statuses.list(pack="<value>", metrics=True, type_=True)
