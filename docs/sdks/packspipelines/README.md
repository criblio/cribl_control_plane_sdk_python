...
<!-- UsageSnippet language="python" operationID="createPipelinesByPack" method="post" path="/p/{pack}/pipelines" -->
```python
...
<!-- UsageSnippet language="python" operationID="updatePipelinesByPackAndId" method="patch" path="/p/{pack}/pipelines/{id}" -->
```python
from cribl_control_plane import CriblControlPlane, models
import os
