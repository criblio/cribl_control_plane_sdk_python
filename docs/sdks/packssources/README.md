...
with CriblControlPlane(
    ...
    res = ccp_client.packs.sources.update(id="<id>", pack="<value>", input_={
        "type": models.InputMicrosoftGraphType.MICROSOFT_GRAPH,
        "url": "https://experienced-tectonics.net/",
        "interval": 194193,
    })
