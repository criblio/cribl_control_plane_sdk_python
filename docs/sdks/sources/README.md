...
with CriblControlPlane(
    ...
    res = ccp_client.sources.create(request={
        ...
        "type": models.CreateInputInputProofpointPodType.PROOFPOINT_POD,
        "cluster_id": "<id>",
        "feed_type": models.CreateInputFeedType.AUDIT,
        "text_secret": "<value>",
    })
