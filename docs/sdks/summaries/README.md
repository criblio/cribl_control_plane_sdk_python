...
<!-- UsageSnippet language="python" operationID="getProductsSummaryByProduct" method="get" path="/products/{product}/summary" example="ProductSummaryResponseExamplesStreamDeploymentSummary" -->
```python
...
**[models.GetProductsSummaryByProductResponse](../../models/getproductssummarybyproductresponse.md)**
