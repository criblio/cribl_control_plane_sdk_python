...
with CriblControlPlane(
    ...
    res = ccp_client.groups.acl.teams.get(product=models.ProductsCore.STREAM, id="<id>", type_=models.RbacResource.DATASETS)
...
**[models.CountedTeamAccessControlList](../../models/countedteamaccesscontrollist.md)**
