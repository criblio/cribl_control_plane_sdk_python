...
import asyncio
from cribl_control_plane.models import ConfigGroup, ConfigGroupCloud, ConfigGroupEstimatedIngestRate, CloudProvider, GroupCreateRequestEstimatedIngestRate, ProductsCore
...
async def main():
    ...
    cribl.groups.create(
        ...
        estimated_ingest_rate=GroupCreateRequestEstimatedIngestRate(group.estimated_ingest_rate.value) if group.estimated_ingest_rate is not None else None,
        name=group.name
    )
