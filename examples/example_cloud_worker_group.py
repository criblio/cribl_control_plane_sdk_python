...
group = ConfigGroup(
    ...
    is_fleet=False,
    is_search=False,
    estimated_ingest_rate=EstimatedIngestRate.RATE24_MB_PER_SEC,  # Equivalent to 24 MB/s maximum estimated ingest rate with 9 Worker Processes
    id=WORKER_GROUP_ID,
...
async def main():
    ...
    group.estimated_ingest_rate = EstimatedIngestRate.RATE48_MB_PER_SEC  # Equivalent to 48 MB/s maximum estimated ingest rate with 21 Worker Processes
