...
class Functions(BaseSDK):
    ...
    def list(
        ...
        *,
    ...
    ) -> Optional[models.GetFunctionsResponse]:
        ...
        def next_func() -> Optional[models.GetFunctionsResponse]:
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.GetFunctionsResponse(
                result=unmarshal_json_response(
                    models.PaginatedFunctionResponse, http_res
                ),
                next=next_func,
            )
    ...
    async def list_async(
        ...
        *,
        ...
        def next_func() -> Awaitable[Optional[models.GetFunctionsResponse]]:
            body = utils.unmarshal_json(http_res.text, Union[Dict[Any, Any], List[Any]])
