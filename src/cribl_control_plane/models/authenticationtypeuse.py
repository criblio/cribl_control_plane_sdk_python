...
class AuthenticationTypeUseTypedDict(TypedDict):
...
class AuthenticationTypeUse(BaseModel):
    ...
    def serialize_auth_type(self, value):
        if isinstance(value, str):
            try:
                return models.AuthenticationMethodOptionsSaslManualSecret(value)
            except ValueError:
                return value
        return value
    ...
    def serialize_client_secret_auth_type(self, value):
        if isinstance(value, str):
            try:
                return models.AuthenticationMethodOptionsSaslCertificateManual(value)
            except ValueError:
                return value
        return value
...
try:
    AuthenticationTypeUse.model_rebuild()
except NameError:
    pass
