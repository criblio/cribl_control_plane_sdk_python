...
class CreateInputInputElasticProxyMode(BaseModel):
    ...
    def serialize_auth_type(self, value):
        if isinstance(value, str):
            try:
                return models.CreateInputInputElasticAuthenticationMethod(value)
            except ValueError:
                return value
        return value
...
class CreateInputInputElastic(BaseModel):
    ...
    def serialize_auth_type(self, value):
        if isinstance(value, str):
            try:
                return models.CreateInputInputElasticAuthenticationType(value)
            except ValueError:
                return value
        return value
...
class CreateInputInputAzureVnetFlowLogType(str, Enum):
    r"""Connector type identifier."""

    AZURE_VNET_FLOW_LOG = "azure_vnet_flow_log"


class CreateInputInputAzureVnetFlowLogTypedDict(TypedDict):
    id: str
    r"""Unique ID for this input"""
    type: CreateInputInputAzureVnetFlowLogType
    r"""Connector type identifier."""
    queue_name: str
...
class CreateInputInputAzureVnetFlowLog(BaseModel):
    id: str
    r"""Unique ID for this input"""
...
class CreateInputInputSplunkHecType(str, Enum):
    r"""Source type identifier."""
...
class CreateInputInputSplunkSearchType(str, Enum):
    r"""Connector type identifier."""
...
class CreateInputInputSplunkSearchTypedDict(TypedDict):
    ...
    auth_type: CreateInputInputSplunkSearchAuthenticationType
    r"""Splunk Search authentication type"""
    disabled: NotRequired[bool]
    r"""If true, the Source is disabled and will not collect data."""
    pipeline: NotRequired[str]
...
class CreateInputInputSplunkSearch(BaseModel):
    ...
    auth_type: Annotated[
        CreateInputInputSplunkSearchAuthenticationType, pydantic.Field(alias="authType")
    ]
    r"""Splunk Search authentication type"""
    ...
    log_level: Annotated[
        Optional[CreateInputInputSplunkSearchLogLevel], pydantic.Field(alias="logLevel")
    ] = None
    r"""Collector runtime log level (verbosity)"""
    ...
    def serialize_log_level(self, value):
        if isinstance(value, str):
            try:
                return models.CreateInputInputSplunkSearchLogLevel(value)
            except ValueError:
                return value
        return value
    ...
    def serialize_auth_type(self, value):
        if isinstance(value, str):
            try:
                return models.CreateInputInputSplunkSearchAuthenticationType(value)
            except ValueError:
                return value
        return value
...
class CreateInputInputHTTPType(str, Enum):
    r"""Source type identifier."""
...
class CreateInputInputCollectionType(str, Enum):
...
class CreateInputInputCollectionTypedDict(TypedDict):
    ...
    id: str
    r"""Unique ID for this input"""
    type: CreateInputInputCollectionType
    r"""Resource type identifier."""
    disabled: NotRequired[bool]
    r"""If true, the Source is disabled and will not collect data."""
    pipeline: NotRequired[str]
...
CreateInputInput = Annotated[
    Union[
        ...
        Annotated[CreateInputInputAzureVnetFlowLog, Tag("azure_vnet_flow_log")],
...
try:
    ...
    pass
try:
    CreateInputInputElasticProxyMode.model_rebuild()
except NameError:
    pass
try:
    ...
    pass
try:
    CreateInputInputAzureVnetFlowLog.model_rebuild()
except NameError:
    pass
try:
    ...
    pass
try:
    CreateInputInputSplunkHecAuthToken.model_rebuild()
except NameError:
    pass
try:
