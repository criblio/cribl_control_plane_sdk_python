...
class CreateInputInputEventhubAmqpAuthenticationMethod(
...
class CreateInputAzureBlobStorageTypedDict(TypedDict):
    ...
    auth_type: NotRequired[CreateInputInputEventhubAmqpAuthenticationMethod]
    r"""Authentication method"""
    text_secret: NotRequired[str]
    r"""Select or create a stored text secret"""
...
class CreateInputAzureBlobStorage(BaseModel):
    ...
    auth_type: Annotated[
        Optional[CreateInputInputEventhubAmqpAuthenticationMethod],
        pydantic.Field(alias="authType"),
    ] = None
    r"""Authentication method"""
    ...
    def serialize_auth_type(self, value):
        if isinstance(value, str):
            try:
                return models.CreateInputInputEventhubAmqpAuthenticationMethod(value)
            except ValueError:
                return value
        return value
