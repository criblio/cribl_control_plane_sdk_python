...
class CreateInputTypeOkta(str, Enum):
...
class CreateInputTypeAnthropicCompliance(str, Enum):
    r"""Connector type identifier."""
...
class CreateInputInputAnthropicComplianceTypedDict(TypedDict):
    id: str
    r"""Unique ID for this input"""
    type: CreateInputTypeAnthropicCompliance
    r"""Connector type identifier."""
    text_secret: str
...
class CreateInputTypeUpwindHec(str, Enum):
...
class CreateInputTypeSysdigHec(str, Enum):
    r"""Source type identifier."""
...
class CreateInputTypeBedrockS3(str, Enum):
    r"""Connector type identifier."""
...
class CreateInputInputOpenaiTypedDict(TypedDict):
    ...
    r"""Connector type identifier."""
    content_config: List[CreateInputContentConfigInputTypedDict]
    r"""Content Types"""
    text_secret: str
...
class CreateInputInputOpenai(BaseModel):
    ...
    content_config: Annotated[
        List[CreateInputContentConfigInput], pydantic.Field(alias="contentConfig")
    ]
    r"""Content Types"""
...
class CreateInputTypeAppleUnifiedLogs(str, Enum):
    r"""Connector type identifier."""

    APPLE_UNIFIED_LOGS = "apple_unified_logs"


class CreateInputReadModeAppleUnifiedLogs(str, Enum, metaclass=utils.OpenEnumMeta):
...
class CreateInputInputAppleUnifiedLogsTypedDict(TypedDict):
    ...
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    pq: NotRequired[PqTypeTypedDict]
    read_mode: NotRequired[CreateInputReadModeAppleUnifiedLogs]
    r"""Read all log entries (historical and upcoming), or only upcoming, from the last entry"""
    metadata: NotRequired[List[MetadataConfInputCollectionTypedDict]]
    r"""Fields to add to events from this input"""
    description: NotRequired[str]
...
class CreateInputInputAppleUnifiedLogs(BaseModel):
    ...
    read_mode: Annotated[
        Optional[CreateInputReadModeAppleUnifiedLogs], pydantic.Field(alias="readMode")
    ] = None
    r"""Read all log entries (historical and upcoming), or only upcoming, from the last entry"""
    ...
    def serialize_read_mode(self, value):
        if isinstance(value, str):
            try:
                return models.CreateInputReadModeAppleUnifiedLogs(value)
            except ValueError:
                return value
        return value
...
class CreateInputReadModeWinEventLogs(str, Enum, metaclass=utils.OpenEnumMeta):
...
class CreateInputInputWinEventLogsTypedDict(TypedDict):
    ...
    read_mode: NotRequired[CreateInputReadModeWinEventLogs]
    r"""Read all stored and future event logs, or only future events"""
...
class CreateInputInputWinEventLogs(BaseModel):
    ...
    read_mode: Annotated[
        Optional[CreateInputReadModeWinEventLogs], pydantic.Field(alias="readMode")
    ] = None
    r"""Read all stored and future event logs, or only future events"""
    ...
    def serialize_read_mode(self, value):
        if isinstance(value, str):
            try:
                return models.CreateInputReadModeWinEventLogs(value)
            except ValueError:
                return value
        return value
...
class CreateInputAuthenticationTypeOpenTelemetry(
    str, Enum, metaclass=utils.OpenEnumMeta
):
...
class CreateInputInputOpenTelemetry(BaseModel):
    ...
    def serialize_auth_type(self, value):
        if isinstance(value, str):
            try:
                return models.CreateInputAuthenticationTypeOpenTelemetry(value)
            except ValueError:
                return value
        return value
...
try:
    ...
    pass
try:
    CreateInputContentConfigInput.model_rebuild()
except NameError:
    pass
try:
