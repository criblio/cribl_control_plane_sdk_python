...
class CreateInputEndpointName(str, Enum, metaclass=utils.OpenEnumMeta):
...
class CreateInputManageStateAnthropicComplianceTypedDict(TypedDict):
    pass


class CreateInputManageStateAnthropicCompliance(BaseModel):
    pass


class CreateInputContentConfigAnthropicComplianceTypedDict(TypedDict):
    content_type: CreateInputEndpointName
    cron_schedule: str
    r"""Schedule on which to run this collection job"""
    ...
    manage_state: NotRequired[CreateInputManageStateAnthropicComplianceTypedDict]
    earliest: NotRequired[str]
    r"""Earliest time for data collection, relative to now"""
    latest: NotRequired[str]
    r"""Latest time for data collection, relative to now"""
...
class CreateInputContentConfigAnthropicCompliance(BaseModel):
    content_type: Annotated[
        CreateInputEndpointName, pydantic.Field(alias="contentType")
    ]
    ...
    manage_state: Annotated[
        Optional[CreateInputManageStateAnthropicCompliance],
    ...
    def serialize_content_type(self, value):
        if isinstance(value, str):
            try:
                return models.CreateInputEndpointName(value)
            except ValueError:
                return value
        return value
...
class CreateInputInputAnthropicComplianceTypedDict(TypedDict):
    ...
    content_config: List[CreateInputContentConfigAnthropicComplianceTypedDict]
    disabled: NotRequired[bool]
    r"""If true, the Source is disabled and will not collect data."""
    pipeline: NotRequired[str]
    r"""Pipeline to process data from this Source before sending it through the Routes"""
...
class CreateInputInputAnthropicCompliance(BaseModel):
    ...
    content_config: Annotated[
        List[CreateInputContentConfigAnthropicCompliance],
...
try:
    ...
    pass
try:
    CreateInputContentConfigAnthropicCompliance.model_rebuild()
except NameError:
    pass
try:
