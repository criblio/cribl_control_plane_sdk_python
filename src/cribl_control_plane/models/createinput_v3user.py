...
class CreateInputV3UserTypedDict(TypedDict):
    ...
    r"""Authentication protocol"""
    auth_key_type: NotRequired[CreateInputV3AuthenticationKeyType]
    r"""Select Manual to enter the key directly, or Secret to use a stored text secret"""
    ...
    r"""Privacy protocol"""
    priv_key_type: NotRequired[CreateInputV3PrivacyKeyType]
    r"""Select Manual to enter the key directly, or Secret to use a stored text secret"""
...
class CreateInputV3User(BaseModel):
    ...
    auth_key_type: Annotated[
        Optional[CreateInputV3AuthenticationKeyType],
    ...
    priv_key_type: Annotated[
        Optional[CreateInputV3PrivacyKeyType], pydantic.Field(alias="privKeyType")
    ] = None
    r"""Select Manual to enter the key directly, or Secret to use a stored text secret"""
    ...
    def serialize_auth_protocol(self, value):
        if isinstance(value, str):
            try:
                return models.CreateInputAuthenticationProtocol(value)
            except ValueError:
                return value
        return value
    ...
    def serialize_auth_key_type(self, value):
        if isinstance(value, str):
            try:
                return models.CreateInputV3AuthenticationKeyType(value)
            except ValueError:
                return value
        return value
    ...
    def serialize_priv_key_type(self, value):
        if isinstance(value, str):
            try:
                return models.CreateInputV3PrivacyKeyType(value)
            except ValueError:
                return value
        return value
