...
class CreateInputSystemByPackTypeAnthropicCompliance(str, Enum):
    r"""Connector type identifier."""
...
class CreateInputSystemByPackInputAnthropicComplianceTypedDict(TypedDict):
    id: str
    r"""Unique ID for this input"""
    type: CreateInputSystemByPackTypeAnthropicCompliance
    r"""Connector type identifier."""
    text_secret: str
...
class CreateInputSystemByPackTypeUpwindHec(str, Enum):
...
class CreateInputSystemByPackInputUpwindHecTypedDict(TypedDict):
    id: str
    r"""Unique ID for this input"""
    type: CreateInputSystemByPackTypeUpwindHec
    r"""Source type identifier."""
    host: str
...
class CreateInputSystemByPackTypeSysdigHec(str, Enum):
    r"""Source type identifier."""
...
class CreateInputSystemByPackInputSysdigHecTypedDict(TypedDict):
    id: str
    r"""Unique ID for this input"""
    type: CreateInputSystemByPackTypeSysdigHec
    r"""Source type identifier."""
    host: str
    r"""Address to bind on. Defaults to 0.0.0.0 (all addresses)."""
    port: float
...
class CreateInputSystemByPackTypeBedrockS3(str, Enum):
    r"""Connector type identifier."""
...
class CreateInputSystemByPackInputBedrockS3TypedDict(TypedDict):
    id: str
    r"""Unique ID for this input"""
    type: CreateInputSystemByPackTypeBedrockS3
    r"""Connector type identifier."""
    queue_name: str
...
class CreateInputSystemByPackInputOpenaiTypedDict(TypedDict):
    ...
    r"""Connector type identifier."""
    content_config: List[CreateInputSystemByPackContentConfigInputTypedDict]
    r"""Content Types"""
    text_secret: str
...
class CreateInputSystemByPackInputOpenai(BaseModel):
    ...
    content_config: Annotated[
        List[CreateInputSystemByPackContentConfigInput],
...
class CreateInputSystemByPackTypeAppleUnifiedLogs(str, Enum):
    r"""Connector type identifier."""

    APPLE_UNIFIED_LOGS = "apple_unified_logs"


class CreateInputSystemByPackReadModeAppleUnifiedLogs(
    str, Enum, metaclass=utils.OpenEnumMeta
):
...
class CreateInputSystemByPackInputAppleUnifiedLogsTypedDict(TypedDict):
    ...
    r"""Direct connections to Destinations, and optionally via a Pipeline or a Pack"""
    pq: NotRequired[PqTypeTypedDict]
    read_mode: NotRequired[CreateInputSystemByPackReadModeAppleUnifiedLogs]
    r"""Read all log entries (historical and upcoming), or only upcoming, from the last entry"""
    metadata: NotRequired[List[MetadataConfInputCollectionTypedDict]]
    r"""Fields to add to events from this input"""
    description: NotRequired[str]
...
class CreateInputSystemByPackInputAppleUnifiedLogs(BaseModel):
    ...
    read_mode: Annotated[
        Optional[CreateInputSystemByPackReadModeAppleUnifiedLogs],
    ...
    def serialize_read_mode(self, value):
        if isinstance(value, str):
            try:
                return models.CreateInputSystemByPackReadModeAppleUnifiedLogs(value)
            except ValueError:
                return value
        return value
...
class CreateInputSystemByPackReadModeWinEventLogs(
    str, Enum, metaclass=utils.OpenEnumMeta
):
...
class CreateInputSystemByPackInputWinEventLogsTypedDict(TypedDict):
    ...
    read_mode: NotRequired[CreateInputSystemByPackReadModeWinEventLogs]
    r"""Read all stored and future event logs, or only future events"""
...
class CreateInputSystemByPackInputWinEventLogs(BaseModel):
    ...
    read_mode: Annotated[
        Optional[CreateInputSystemByPackReadModeWinEventLogs],
        pydantic.Field(alias="readMode"),
    ] = None
    r"""Read all stored and future event logs, or only future events"""
    ...
    def serialize_read_mode(self, value):
        if isinstance(value, str):
            try:
                return models.CreateInputSystemByPackReadModeWinEventLogs(value)
            except ValueError:
                return value
        return value
...
try:
    ...
    pass
try:
    CreateInputSystemByPackContentConfigInput.model_rebuild()
except NameError:
    pass
try:
