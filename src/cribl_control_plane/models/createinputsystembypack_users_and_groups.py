...
class CreateInputSystemByPackEndpointName(str, Enum, metaclass=utils.OpenEnumMeta):
...
class CreateInputSystemByPackManageStateAnthropicComplianceTypedDict(TypedDict):
    pass


class CreateInputSystemByPackManageStateAnthropicCompliance(BaseModel):
    pass


class CreateInputSystemByPackContentConfigAnthropicComplianceTypedDict(TypedDict):
    content_type: CreateInputSystemByPackEndpointName
    cron_schedule: str
    r"""Schedule on which to run this collection job"""
...
class CreateInputSystemByPackContentConfigAnthropicCompliance(BaseModel):
    content_type: Annotated[
        CreateInputSystemByPackEndpointName, pydantic.Field(alias="contentType")
    ]
    ...
    manage_state: Annotated[
        Optional[CreateInputSystemByPackManageStateAnthropicCompliance],
    ...
    def serialize_content_type(self, value):
        if isinstance(value, str):
            try:
                return models.CreateInputSystemByPackEndpointName(value)
            except ValueError:
                return value
        return value
...
class CreateInputSystemByPackInputAnthropicComplianceTypedDict(TypedDict):
    ...
    content_config: List[
        CreateInputSystemByPackContentConfigAnthropicComplianceTypedDict
    ]
    disabled: NotRequired[bool]
    r"""If true, the Source is disabled and will not collect data."""
    pipeline: NotRequired[str]
...
class CreateInputSystemByPackInputAnthropicCompliance(BaseModel):
    ...
    content_config: Annotated[
        List[CreateInputSystemByPackContentConfigAnthropicCompliance],
