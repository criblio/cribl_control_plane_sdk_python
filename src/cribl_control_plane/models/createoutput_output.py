...
from .createoutput_outputgraphite_type import (
    ...
    CreateOutputOutputCriblMetrics,
    CreateOutputOutputCriblMetricsTypedDict,
...
from .createoutput_outputwebhook_authentication_type_1 import (
...
CreateOutputOutput = Annotated[
    Union[
        ...
        Annotated[CreateOutputOutputCriblMetrics, Tag("cribl_metrics")],
