...
class CreateOutputGoogleAuthenticationMethodGoogleCloudObservability(
    str, Enum, metaclass=utils.OpenEnumMeta
):
...
class CreateOutputOutputGoogleCloudObservabilityTypedDict(TypedDict):
    ...
    google_auth_method: CreateOutputGoogleAuthenticationMethodGoogleCloudObservability
    r"""Choose Auto to use Google Application Default Credentials (ADC). Choose Secret to select or create a stored secret that references Google service account credentials."""
    pipeline: NotRequired[str]
    r"""Pipeline to process data before sending out to this output"""
    system_fields: NotRequired[List[str]]
...
class CreateOutputOutputGoogleCloudObservability(BaseModel):
    ...
    def serialize_google_auth_method(self, value):
        if isinstance(value, str):
            try:
                return models.CreateOutputGoogleAuthenticationMethodGoogleCloudObservability(
                    value
                )
            except ValueError:
                return value
...
class CreateOutputTypeGoogleBigquery(str, Enum):
    GOOGLE_BIGQUERY = "google_bigquery"


class CreateOutputGoogleAuthenticationMethodGoogleBigquery(
    str, Enum, metaclass=utils.OpenEnumMeta
):
...
class CreateOutputPqControlsGoogleBigqueryTypedDict(TypedDict):
    pass


class CreateOutputPqControlsGoogleBigquery(BaseModel):
    pass
...
class CreateOutputOutputGoogleBigqueryTypedDict(TypedDict):
    id: str
    r"""Unique ID for this output"""
    type: CreateOutputTypeGoogleBigquery
    project_id: str
    ...
    table_id: str
    r"""BigQuery table ID"""
    google_auth_method: CreateOutputGoogleAuthenticationMethodGoogleBigquery
    r"""Choose Auto to use Google Application Default Credentials (ADC), or Secret to select or create a stored secret that references Google service account credentials"""
    pipeline: NotRequired[str]
    r"""Pipeline to process data before sending out to this output"""
    system_fields: NotRequired[List[str]]
    ...
    pq_max_buffer_size_bytes: NotRequired[str]
    r"""The maximum size to hold in memory before writing events to disk. Enter a numeral with units of KB, MB, etc. The minimum value is 64KB and the maximum value is 10MB."""
    pq_controls: NotRequired[CreateOutputPqControlsGoogleBigqueryTypedDict]
    template_streamtags: NotRequired[str]
    r"""Binds 'streamtags' to a variable for dynamic value resolution. Set to variable ID (pack-scoped) or 'cribl.'/'edge.' prefixed ID (group-scoped). Variable value overrides 'streamtags' at runtime."""
...
class CreateOutputOutputGoogleBigquery(BaseModel):
    ...
    pq_controls: Annotated[
        Optional[CreateOutputPqControlsGoogleBigquery],
        pydantic.Field(alias="pqControls"),
    ] = None
    ...
    def serialize_google_auth_method(self, value):
        if isinstance(value, str):
            try:
                return models.CreateOutputGoogleAuthenticationMethodGoogleBigquery(
                    value
                )
            except ValueError:
                return value
