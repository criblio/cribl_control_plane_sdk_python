...
class CreateOutputTypeGoogleCloudObservability(str, Enum):
    GOOGLE_CLOUD_OBSERVABILITY = "google_cloud_observability"


class CreateOutputProtocolGoogleCloudObservability(
    str, Enum, metaclass=utils.OpenEnumMeta
):
    GRPC = "grpc"


class CreateOutputOtlpVersionGoogleCloudObservability(
    str, Enum, metaclass=utils.OpenEnumMeta
):
    ONE_DOT_3_DOT_1 = "1.3.1"


class CreateOutputEndpointGoogleCloudObservability(
    str, Enum, metaclass=utils.OpenEnumMeta
):
...
class CreateOutputGoogleAuthenticationMethod(str, Enum, metaclass=utils.OpenEnumMeta):
...
class CreateOutputPqControlsGoogleCloudObservabilityTypedDict(TypedDict):
    pass


class CreateOutputPqControlsGoogleCloudObservability(BaseModel):
    pass
...
class CreateOutputOutputGoogleCloudObservabilityTypedDict(TypedDict):
    id: str
    r"""Unique ID for this output"""
    type: CreateOutputTypeGoogleCloudObservability
    google_auth_method: CreateOutputGoogleAuthenticationMethod
    r"""Choose Auto to use Google Application Default Credentials (ADC). Choose Secret to select or create a stored secret that references Google service account credentials."""
    pipeline: NotRequired[str]
    r"""Pipeline to process data before sending out to this output"""
    system_fields: NotRequired[List[str]]
    ...
    streamtags: NotRequired[List[str]]
    r"""Tags for filtering and grouping in @{product}"""
    protocol: NotRequired[CreateOutputProtocolGoogleCloudObservability]
    otlp_version: NotRequired[CreateOutputOtlpVersionGoogleCloudObservability]
    endpoint: NotRequired[CreateOutputEndpointGoogleCloudObservability]
    r"""Fixed Google Cloud Observability gRPC endpoint. All three signals share this transport; the OTLP service path determines whether the call lands on traces, metrics, or logs."""
    ...
    pq_max_buffer_size_bytes: NotRequired[str]
    r"""The maximum size to hold in memory before writing events to disk. Enter a numeral with units of KB, MB, etc. The minimum value is 64KB and the maximum value is 1MB."""
    pq_controls: NotRequired[CreateOutputPqControlsGoogleCloudObservabilityTypedDict]
    template_streamtags: NotRequired[str]
    r"""Binds 'streamtags' to a variable for dynamic value resolution. Set to variable ID (pack-scoped) or 'cribl.'/'edge.' prefixed ID (group-scoped). Variable value overrides 'streamtags' at runtime."""
    template_failed_request_logging_mode: NotRequired[str]
    r"""Binds 'failedRequestLoggingMode' to a variable for dynamic value resolution. Set to variable ID (pack-scoped) or 'cribl.'/'edge.' prefixed ID (group-scoped). Variable value overrides 'failedRequestLoggingMode' at runtime."""
...
class CreateOutputOutputGoogleCloudObservability(BaseModel):
    ...
    google_auth_method: Annotated[
        CreateOutputGoogleAuthenticationMethod, pydantic.Field(alias="googleAuthMethod")
    ]
    r"""Choose Auto to use Google Application Default Credentials (ADC). Choose Secret to select or create a stored secret that references Google service account credentials."""
    ...
    protocol: Optional[CreateOutputProtocolGoogleCloudObservability] = None

    otlp_version: Annotated[
        Optional[CreateOutputOtlpVersionGoogleCloudObservability],
        pydantic.Field(alias="otlpVersion"),
    ] = None

    endpoint: Optional[CreateOutputEndpointGoogleCloudObservability] = None
    r"""Fixed Google Cloud Observability gRPC endpoint. All three signals share this transport; the OTLP service path determines whether the call lands on traces, metrics, or logs."""
    ...
    pq_controls: Annotated[
        Optional[CreateOutputPqControlsGoogleCloudObservability],
        pydantic.Field(alias="pqControls"),
    ] = None
    ...
    def serialize_protocol(self, value):
        if isinstance(value, str):
            try:
                return models.CreateOutputProtocolGoogleCloudObservability(value)
            except ValueError:
                return value
        return value
    ...
    def serialize_otlp_version(self, value):
        if isinstance(value, str):
            try:
                return models.CreateOutputOtlpVersionGoogleCloudObservability(value)
            except ValueError:
                return value
        return value
    ...
    def serialize_endpoint(self, value):
        if isinstance(value, str):
            try:
                return models.CreateOutputEndpointGoogleCloudObservability(value)
            except ValueError:
                return value
        return value
    ...
    def serialize_google_auth_method(self, value):
        if isinstance(value, str):
            try:
                return models.CreateOutputGoogleAuthenticationMethod(value)
            except ValueError:
                return value
        return value
