...
from .createoutput_type_statsd import (
...
class CreateOutputOutputElasticCloudTypedDict(TypedDict):
    id: str
    r"""Unique ID for this output"""
    type: CreateOutputTypeElasticCloud
    url: str
...
class CreateOutputOutputConfluentCloudTypedDict(TypedDict):
    id: str
    r"""Unique ID for this output"""
    type: CreateOutputTypeConfluentCloud
    brokers: List[str]
...
class CreateOutputOutputGoogleCloudStorageTypedDict(TypedDict):
    id: str
    r"""Unique ID for this output"""
    type: CreateOutputTypeGoogleCloudStorage
    bucket: str
...
class CreateOutputOutputAzureEventhubTypedDict(TypedDict):
    id: str
    r"""Unique ID for this output"""
    type: CreateOutputTypeAzureEventhub
    brokers: List[str]
...
class CreateOutputOutputAzureDataExplorerTypedDict(TypedDict):
    id: str
    r"""Unique ID for this output"""
    type: CreateOutputTypeAzureDataExplorer
    cluster_url: str
...
class CreateOutputOutputSplunkHecTypedDict(TypedDict):
    id: str
    r"""Unique ID for this output"""
    type: CreateOutputTypeSplunkHec
    pipeline: NotRequired[str]
    r"""Pipeline to process data before sending out to this output"""
    system_fields: NotRequired[List[str]]
    r"""Fields to automatically add to events, such as cribl_pipe. Supports wildcards."""
...
class CreateOutputOutputSentinel(BaseModel):
    ...
    def serialize_auth_type(self, value):
        if isinstance(value, str):
            try:
                return models.CreateOutputAuthType(value)
            except ValueError:
                return value
        return value
    ...
    def serialize_endpoint_url_configuration(self, value):
        if isinstance(value, str):
            try:
                return models.CreateOutputEndpointConfiguration(value)
            except ValueError:
                return value
        return value
...
class CreateOutputOutputWebhookType2(str, Enum):
    WEBHOOK = "webhook"


class CreateOutputOutputWebhookFormat2(str, Enum, metaclass=utils.OpenEnumMeta):
...
try:
    ...
    pass
try:
    CreateOutputURLElastic.model_rebuild()
except NameError:
    pass
try:
...
try:
    ...
    pass
try:
    CreateOutputURLSplunkHec.model_rebuild()
except NameError:
    pass
try:
