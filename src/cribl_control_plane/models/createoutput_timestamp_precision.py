...
class CreateOutputAuthenticationMethodNutanixObjects(
...
class CreateOutputOutputNutanixObjects(BaseModel):
    ...
    aws_authentication_method: Annotated[
        Optional[CreateOutputAuthenticationMethodNutanixObjects],
    ...
    def serialize_aws_authentication_method(self, value):
        if isinstance(value, str):
            try:
                return models.CreateOutputAuthenticationMethodNutanixObjects(value)
            except ValueError:
                return value
        return value
