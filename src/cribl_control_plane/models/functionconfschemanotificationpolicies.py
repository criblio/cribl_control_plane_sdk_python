...
class FunctionConfSchemaNotificationPoliciesTemplateTargetPairTypedDict(TypedDict):
    template_id: str
...
class FunctionConfSchemaNotificationPoliciesTemplateTargetPair(BaseModel):
...
try:
    FunctionConfSchemaNotificationPoliciesTemplateTargetPair.model_rebuild()
except NameError:
    pass
try:
