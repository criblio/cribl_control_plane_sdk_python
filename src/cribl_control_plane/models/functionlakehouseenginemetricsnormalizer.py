...
class FunctionLakehouseEngineMetricsNormalizerID(str, Enum):
...
class FunctionLakehouseEngineMetricsNormalizerTypedDict(TypedDict):
    filename: str
    r"""Path to the JavaScript file that implements the Function."""
    group: str
    r"""Category group the Function belongs to."""
    id: FunctionLakehouseEngineMetricsNormalizerID
    r"""Identifier of the Function. Always <code>lakehouse_engine_metrics_normalizer</code>"""
    load_time: float
...
class FunctionLakehouseEngineMetricsNormalizer(BaseModel):
...
try:
    FunctionLakehouseEngineMetricsNormalizer.model_rebuild()
except NameError:
    pass
