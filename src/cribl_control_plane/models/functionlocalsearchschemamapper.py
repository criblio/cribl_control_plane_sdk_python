...
class FunctionLocalSearchSchemaMapperID(str, Enum):
    LOCAL_SEARCH_SCHEMA_MAPPER = "local_search_schema_mapper"


class FunctionLocalSearchSchemaMapperTypedDict(TypedDict):
    filename: str
    group: str
    id: FunctionLocalSearchSchemaMapperID
    load_time: float
    mod_time: float
    name: str
...
class FunctionLocalSearchSchemaMapper(BaseModel):
...
try:
    FunctionLocalSearchSchemaMapper.model_rebuild()
except NameError:
    pass
