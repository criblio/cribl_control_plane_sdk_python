...
class FunctionLocalSearchTimeRangeNormalizerID(str, Enum):
...
class FunctionLocalSearchTimeRangeNormalizerTypedDict(TypedDict):
    filename: str
    r"""Path to the JavaScript file that implements the Function."""
    group: str
    r"""Category group the Function belongs to."""
    id: FunctionLocalSearchTimeRangeNormalizerID
    r"""Identifier of the Function. Always <code>local_search_time_range_normalizer</code>"""
    load_time: float
...
class FunctionLocalSearchTimeRangeNormalizer(BaseModel):
...
try:
    FunctionLocalSearchTimeRangeNormalizer.model_rebuild()
except NameError:
    pass
