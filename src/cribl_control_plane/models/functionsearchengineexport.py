...
class FunctionSearchEngineExportID(str, Enum):
    SEARCH_ENGINE_EXPORT = "search_engine_export"


class FunctionSearchEngineExportTypedDict(TypedDict):
    filename: str
    group: str
    id: FunctionSearchEngineExportID
    load_time: float
    mod_time: float
    name: str
...
class FunctionSearchEngineExport(BaseModel):
...
try:
    FunctionSearchEngineExport.model_rebuild()
except NameError:
    pass
