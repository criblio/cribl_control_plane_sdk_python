...
class GetInputStatusSystemInputsByPackAndIDRequestTypedDict(TypedDict):
    id: str
...
class GetInputStatusSystemInputsByPackAndIDRequest(BaseModel):
    id: Annotated[
