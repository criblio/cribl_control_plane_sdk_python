...
InputUnion1TypedDict = TypeAliasType(
...
class UnknownInputUnion1(BaseModel):
    r"""A InputUnion1 variant the SDK doesn't recognize. Preserves the raw payload."""
...
_INPUT_UNION_1_VARIANTS: dict[str, Any] = {
...
InputUnion1 = Annotated[
    ...
    BeforeValidator(
        partial(
            parse_open_union,
            disc_key="type",
            variants=_INPUT_UNION_1_VARIANTS,
            unknown_cls=UnknownInputUnion1,
            union_name="InputUnion1",
        )
    ),
]
