...
class InputAkamaiHecType(str, Enum):
    r"""Source type identifier."""

    AKAMAI_HEC = "akamai_hec"


class InputAkamaiHecInputTypedDict(TypedDict):
    type: InputAkamaiHecType
    r"""Source type identifier."""
    host: str
...
class InputAkamaiHecInput(BaseModel):
    type: InputAkamaiHecType
    r"""Source type identifier."""
...
try:
    InputAkamaiHecInput.model_rebuild()
except NameError:
    pass
