...
class InputAquaSecurityHecType(str, Enum):
    r"""Source type identifier."""

    AQUA_SECURITY_HEC = "aqua_security_hec"


class InputAquaSecurityHecInputTypedDict(TypedDict):
    type: InputAquaSecurityHecType
    r"""Source type identifier."""
    host: str
...
class InputAquaSecurityHecInput(BaseModel):
    type: InputAquaSecurityHecType
    r"""Source type identifier."""
...
try:
    InputAquaSecurityHecInput.model_rebuild()
except NameError:
    pass
