...
class InputBedrockS3Type(str, Enum):
    r"""Connector type identifier."""

    BEDROCK_S3 = "bedrock_s3"


class InputBedrockS3InputTypedDict(TypedDict):
    type: InputBedrockS3Type
    r"""Connector type identifier."""
    queue_name: str
...
class InputBedrockS3Input(BaseModel):
    type: InputBedrockS3Type
    r"""Connector type identifier."""
...
try:
    InputBedrockS3Input.model_rebuild()
except NameError:
    pass
