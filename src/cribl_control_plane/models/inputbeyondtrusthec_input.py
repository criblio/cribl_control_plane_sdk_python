...
class InputBeyondtrustHecType(str, Enum):
    r"""Source type identifier."""

    BEYONDTRUST_HEC = "beyondtrust_hec"


class InputBeyondtrustHecInputTypedDict(TypedDict):
    type: InputBeyondtrustHecType
    r"""Source type identifier."""
    host: str
...
class InputBeyondtrustHecInput(BaseModel):
    type: InputBeyondtrustHecType
    r"""Source type identifier."""
...
try:
    InputBeyondtrustHecInput.model_rebuild()
except NameError:
    pass
