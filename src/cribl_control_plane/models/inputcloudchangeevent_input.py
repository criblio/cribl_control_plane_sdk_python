...
class InputCloudChangeEventType(str, Enum):
    r"""Connector type identifier."""

    CLOUD_CHANGE_EVENT = "cloud_change_event"


class InputCloudChangeEventInputTypedDict(TypedDict):
    type: InputCloudChangeEventType
    r"""Connector type identifier."""
    queue_name: str
...
class InputCloudChangeEventInput(BaseModel):
    type: InputCloudChangeEventType
    r"""Connector type identifier."""
...
try:
    InputCloudChangeEventInput.model_rebuild()
except NameError:
    pass
