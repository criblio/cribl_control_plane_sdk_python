...
class InputCloudChangeFirehoseType(str, Enum):
    r"""Source type identifier."""

    CLOUD_CHANGE_FIREHOSE = "cloud_change_firehose"


class InputCloudChangeFirehoseInputTypedDict(TypedDict):
    type: InputCloudChangeFirehoseType
    r"""Source type identifier."""
    host: str
...
class InputCloudChangeFirehoseInput(BaseModel):
    type: InputCloudChangeFirehoseType
    r"""Source type identifier."""
...
try:
    InputCloudChangeFirehoseInput.model_rebuild()
except NameError:
    pass
