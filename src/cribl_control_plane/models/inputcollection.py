...
class InputCollectionType4(str, Enum):
    COLLECTION = "collection"


class InputCollectionCollection4TypedDict(TypedDict):
    pq: PqTypeTypedDict
    pq_enabled: NotRequired[bool]
    r"""Use a disk queue to minimize data loss when connected services block. See [Cribl Docs](https://docs.cribl.io/stream/persistent-queues) for PQ defaults (Cribl-managed Cloud Workers) and configuration options (on-prem and hybrid Workers)."""
    id: NotRequired[str]
    r"""Unique ID for this input"""
    type: NotRequired[InputCollectionType4]
...
class InputCollectionCollection4(BaseModel):
    pq: PqType
    ...
    type: Optional[InputCollectionType4] = InputCollectionType4.COLLECTION
...
class InputCollectionType3(str, Enum):
    COLLECTION = "collection"


class InputCollectionCollection3TypedDict(TypedDict):
    pq_enabled: NotRequired[bool]
    r"""Use a disk queue to minimize data loss when connected services block. See [Cribl Docs](https://docs.cribl.io/stream/persistent-queues) for PQ defaults (Cribl-managed Cloud Workers) and configuration options (on-prem and hybrid Workers)."""
    id: NotRequired[str]
    r"""Unique ID for this input"""
    type: NotRequired[InputCollectionType3]
    disabled: NotRequired[bool]
    pipeline: NotRequired[str]
    r"""Pipeline to process results"""
    send_to_routes: NotRequired[bool]
...
class InputCollectionCollection3(BaseModel):
    pq_enabled: Annotated[Optional[bool], pydantic.Field(alias="pqEnabled")] = False
    r"""Use a disk queue to minimize data loss when connected services block. See [Cribl Docs](https://docs.cribl.io/stream/persistent-queues) for PQ defaults (Cribl-managed Cloud Workers) and configuration options (on-prem and hybrid Workers)."""
    ...
    type: Optional[InputCollectionType3] = InputCollectionType3.COLLECTION
...
class InputCollectionType2(str, Enum):
    COLLECTION = "collection"


class InputCollectionCollection2TypedDict(TypedDict):
    pipeline: str
    r"""Pipeline to process results"""
    output: str
    r"""Destination to send results to"""
    ...
    id: NotRequired[str]
    r"""Unique ID for this input"""
    type: NotRequired[InputCollectionType2]
    disabled: NotRequired[bool]
    environment: NotRequired[str]
    r"""Optionally, enable this config only on a specified Git branch. If empty, will be enabled everywhere."""
    pq_enabled: NotRequired[bool]
...
class InputCollectionCollection2(BaseModel):
    pipeline: str
    r"""Pipeline to process results"""
    ...
    type: Optional[InputCollectionType2] = InputCollectionType2.COLLECTION
...
class InputCollectionType1(str, Enum):
    COLLECTION = "collection"


class InputCollectionCollection1TypedDict(TypedDict):
    pipeline: str
    r"""Pipeline to process results"""
    send_to_routes: NotRequired[bool]
    r"""Send events to normal routing and event processing. Disable to select a specific Pipeline/Destination combination."""
    id: NotRequired[str]
    r"""Unique ID for this input"""
    type: NotRequired[InputCollectionType1]
    disabled: NotRequired[bool]
    environment: NotRequired[str]
    r"""Optionally, enable this config only on a specified Git branch. If empty, will be enabled everywhere."""
    pq_enabled: NotRequired[bool]
...
class InputCollectionCollection1(BaseModel):
    pipeline: str
    r"""Pipeline to process results"""
    ...
    type: Optional[InputCollectionType1] = InputCollectionType1.COLLECTION
