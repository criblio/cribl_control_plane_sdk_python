...
class InputConfluentCloudInputCollectionPart1Type1TypedDict(TypedDict):
...
class InputConfluentCloudInputCollectionPart1Type1(BaseModel):
    type: InputConfluentCloudType
...
class InputConfluentCloudInputCollectionPart0Type1TypedDict(TypedDict):
    type: InputConfluentCloudType
    brokers: List[str]
    r"""List of Confluent Cloud bootstrap servers to use, such as yourAccount.confluent.cloud:9092"""
    topics: List[str]
...
class InputConfluentCloudInputCollectionPart0Type1(BaseModel):
    type: InputConfluentCloudType
...
class InputConfluentCloudInputCollectionPart1TypeTypedDict(TypedDict):
    type: InputConfluentCloudType
    brokers: List[str]
    r"""List of Confluent Cloud bootstrap servers to use, such as yourAccount.confluent.cloud:9092"""
    topics: List[str]
...
class InputConfluentCloudInputCollectionPart1Type(BaseModel):
    type: InputConfluentCloudType
...
class InputConfluentCloudInputCollectionPart0TypeTypedDict(TypedDict):
    type: InputConfluentCloudType
    brokers: List[str]
    r"""List of Confluent Cloud bootstrap servers to use, such as yourAccount.confluent.cloud:9092"""
    topics: List[str]
...
class InputConfluentCloudInputCollectionPart0Type(BaseModel):
    type: InputConfluentCloudType
