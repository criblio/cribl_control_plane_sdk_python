...
class InputConfluentCloudConfluentCloud4TypedDict(TypedDict):
    ...
    kafka_schema_registry: NotRequired[KafkaSchemaRegistryTypeTypedDict]
...
class InputConfluentCloudConfluentCloud4(BaseModel):
    type: TypeConfluentCloudOption
    ...
    kafka_schema_registry: Annotated[
        Optional[KafkaSchemaRegistryType], pydantic.Field(alias="kafkaSchemaRegistry")
    ] = None
...
class InputConfluentCloudConfluentCloud3TypedDict(TypedDict):
    type: TypeConfluentCloudOption
    brokers: List[str]
    r"""List of Confluent Cloud bootstrap servers to use, such as yourAccount.confluent.cloud:9092"""
    topics: List[str]
...
class InputConfluentCloudConfluentCloud3(BaseModel):
    type: TypeConfluentCloudOption
...
class InputConfluentCloudConfluentCloud2TypedDict(TypedDict):
    type: TypeConfluentCloudOption
...
class InputConfluentCloudConfluentCloud2(BaseModel):
    type: TypeConfluentCloudOption
...
class InputConfluentCloudConfluentCloud1TypedDict(TypedDict):
    type: TypeConfluentCloudOption
    brokers: List[str]
    r"""List of Confluent Cloud bootstrap servers to use, such as yourAccount.confluent.cloud:9092"""
    topics: List[str]
...
class InputConfluentCloudConfluentCloud1(BaseModel):
    type: TypeConfluentCloudOption
