...
class InputCriblHTTPCriblHTTP4TypedDict(TypedDict):
...
class InputCriblHTTPCriblHTTP4(BaseModel):
    type: TypeCriblHTTPOption
...
class InputCriblHTTPCriblHTTP3TypedDict(TypedDict):
    type: TypeCriblHTTPOption
    port: float
    r"""Port to listen on"""
    pq_enabled: NotRequired[bool]
...
class InputCriblHTTPCriblHTTP3(BaseModel):
    type: TypeCriblHTTPOption
...
class InputCriblHTTPCriblHTTP2TypedDict(TypedDict):
    type: TypeCriblHTTPOption
...
class InputCriblHTTPCriblHTTP2(BaseModel):
    type: TypeCriblHTTPOption
...
class InputCriblHTTPCriblHTTP1TypedDict(TypedDict):
    type: TypeCriblHTTPOption
    port: float
    r"""Port to listen on"""
    send_to_routes: NotRequired[bool]
...
class InputCriblHTTPCriblHTTP1(BaseModel):
    type: TypeCriblHTTPOption
