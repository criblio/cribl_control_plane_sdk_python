...
class InputCriblLakeHTTPPqEnabledTrueWithPqConstraintTypedDict(TypedDict):
...
class InputCriblLakeHTTPPqEnabledTrueWithPqConstraint(BaseModel):
    type: InputCriblLakeHTTPType
...
class InputCriblLakeHTTPPqEnabledFalseWithPqConstraintTypedDict(TypedDict):
    type: InputCriblLakeHTTPType
    port: float
    r"""Port to listen on"""
    pq_enabled: NotRequired[bool]
...
class InputCriblLakeHTTPPqEnabledFalseWithPqConstraint(BaseModel):
    type: InputCriblLakeHTTPType
...
class InputCriblLakeHTTPSendToRoutesFalseWithConnectionsConstraintTypedDict(TypedDict):
    type: InputCriblLakeHTTPType
    port: float
    r"""Port to listen on"""
    send_to_routes: NotRequired[bool]
...
class InputCriblLakeHTTPSendToRoutesFalseWithConnectionsConstraint(BaseModel):
    type: InputCriblLakeHTTPType
...
class InputCriblLakeHTTPSendToRoutesTrueWithConnectionsConstraintTypedDict(TypedDict):
    type: InputCriblLakeHTTPType
    port: float
    r"""Port to listen on"""
    send_to_routes: NotRequired[bool]
...
class InputCriblLakeHTTPSendToRoutesTrueWithConnectionsConstraint(BaseModel):
    type: InputCriblLakeHTTPType
