...
InputCriblLakeHTTPAuthTokensExtUnionTypedDict = TypeAliasType(
    "InputCriblLakeHTTPAuthTokensExtUnionTypedDict",
    Union[
...
InputCriblLakeHTTPAuthTokensExtUnion = TypeAliasType(
    "InputCriblLakeHTTPAuthTokensExtUnion",
    Union[
...
class InputCriblLakeHTTPInputTypedDict(TypedDict):
    ...
    auth_tokens_ext: NotRequired[List[InputCriblLakeHTTPAuthTokensExtUnionTypedDict]]
    r"""Auth tokens"""
    description: NotRequired[str]
...
class InputCriblLakeHTTPInput(BaseModel):
    ...
    auth_tokens_ext: Annotated[
        Optional[List[InputCriblLakeHTTPAuthTokensExtUnion]],
