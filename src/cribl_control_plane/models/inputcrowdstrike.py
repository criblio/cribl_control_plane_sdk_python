...
class InputCrowdstrikeType9(str, Enum):
    CROWDSTRIKE = "crowdstrike"


class InputCrowdstrikeCrowdstrike9TypedDict(TypedDict):
...
class InputCrowdstrikeCrowdstrike9(BaseModel):
...
class InputCrowdstrikeType8(str, Enum):
    CROWDSTRIKE = "crowdstrike"


class InputCrowdstrikeCrowdstrike8TypedDict(TypedDict):
    tag_after_processing: TagAfterProcessingOptions
...
class InputCrowdstrikeCrowdstrike8(BaseModel):
    tag_after_processing: Annotated[
        Annotated[TagAfterProcessingOptions, PlainValidator(validate_open_enum(False))],
        pydantic.Field(alias="tagAfterProcessing"),
    ]
...
class InputCrowdstrikeType7(str, Enum):
    CROWDSTRIKE = "crowdstrike"


class InputCrowdstrikeCrowdstrike7TypedDict(TypedDict):
...
class InputCrowdstrikeCrowdstrike7(BaseModel):
    type: InputCrowdstrikeType7
...
class InputCrowdstrikeType6(str, Enum):
    CROWDSTRIKE = "crowdstrike"


class InputCrowdstrikeCrowdstrike6TypedDict(TypedDict):
...
class InputCrowdstrikeCrowdstrike6(BaseModel):
    type: InputCrowdstrikeType6
...
class InputCrowdstrikeType5(str, Enum):
    CROWDSTRIKE = "crowdstrike"


class InputCrowdstrikeCrowdstrike5TypedDict(TypedDict):
...
class InputCrowdstrikeCrowdstrike5(BaseModel):
    type: InputCrowdstrikeType5
...
class InputCrowdstrikeType4(str, Enum):
    CROWDSTRIKE = "crowdstrike"


class InputCrowdstrikeCrowdstrike4TypedDict(TypedDict):
...
class InputCrowdstrikeCrowdstrike4(BaseModel):
    type: InputCrowdstrikeType4
...
class InputCrowdstrikeType3(str, Enum):
    CROWDSTRIKE = "crowdstrike"


class InputCrowdstrikeCrowdstrike3TypedDict(TypedDict):
...
class InputCrowdstrikeCrowdstrike3(BaseModel):
    type: InputCrowdstrikeType3
...
class InputCrowdstrikeType2(str, Enum):
    CROWDSTRIKE = "crowdstrike"


class InputCrowdstrikeCrowdstrike2TypedDict(TypedDict):
...
class InputCrowdstrikeCrowdstrike2(BaseModel):
    type: InputCrowdstrikeType2
...
class InputCrowdstrikeType1(str, Enum):
    CROWDSTRIKE = "crowdstrike"


class InputCrowdstrikeCrowdstrike1TypedDict(TypedDict):
...
class InputCrowdstrikeCrowdstrike1(BaseModel):
    type: InputCrowdstrikeType1
