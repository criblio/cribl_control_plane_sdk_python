...
class InputCrowdstrikeInputCollectionPart1Type1TypedDict(TypedDict):
...
class InputCrowdstrikeInputCollectionPart1Type1(BaseModel):
    type: InputCrowdstrikeType
...
class InputCrowdstrikeInputCollectionPart0Type1TypedDict(TypedDict):
    type: InputCrowdstrikeType
    queue_name: str
    r"""The name, URL, or ARN of the SQS queue to read notifications from. When a non-AWS URL is specified, format must be: '{url}/myQueueName'. Example: 'https://host:port/myQueueName'. Value must be a JavaScript expression (which can evaluate to a constant value), enclosed in quotes or backticks. Can be evaluated only at init time. Example referencing a Global Variable: `https://host:port/myQueue-${C.vars.myVar}`."""
    pq_enabled: NotRequired[bool]
...
class InputCrowdstrikeInputCollectionPart0Type1(BaseModel):
    type: InputCrowdstrikeType
...
class InputCrowdstrikeInputCollectionPart1TypeTypedDict(TypedDict):
    type: InputCrowdstrikeType
    queue_name: str
    r"""The name, URL, or ARN of the SQS queue to read notifications from. When a non-AWS URL is specified, format must be: '{url}/myQueueName'. Example: 'https://host:port/myQueueName'. Value must be a JavaScript expression (which can evaluate to a constant value), enclosed in quotes or backticks. Can be evaluated only at init time. Example referencing a Global Variable: `https://host:port/myQueue-${C.vars.myVar}`."""
    send_to_routes: NotRequired[bool]
...
class InputCrowdstrikeInputCollectionPart1Type(BaseModel):
    type: InputCrowdstrikeType
...
class InputCrowdstrikeInputCollectionPart0TypeTypedDict(TypedDict):
    type: InputCrowdstrikeType
    queue_name: str
    r"""The name, URL, or ARN of the SQS queue to read notifications from. When a non-AWS URL is specified, format must be: '{url}/myQueueName'. Example: 'https://host:port/myQueueName'. Value must be a JavaScript expression (which can evaluate to a constant value), enclosed in quotes or backticks. Can be evaluated only at init time. Example referencing a Global Variable: `https://host:port/myQueue-${C.vars.myVar}`."""
    send_to_routes: NotRequired[bool]
...
class InputCrowdstrikeInputCollectionPart0Type(BaseModel):
    type: InputCrowdstrikeType
