...
class InputDatadogAgentPqEnabledTrueWithPqConstraintTypedDict(TypedDict):
...
class InputDatadogAgentPqEnabledTrueWithPqConstraint(BaseModel):
    type: InputDatadogAgentType
...
class InputDatadogAgentPqEnabledFalseWithPqConstraintTypedDict(TypedDict):
    type: InputDatadogAgentType
    port: float
    r"""Port to listen on"""
    pq_enabled: NotRequired[bool]
...
class InputDatadogAgentPqEnabledFalseWithPqConstraint(BaseModel):
    type: InputDatadogAgentType
...
class InputDatadogAgentSendToRoutesFalseWithConnectionsConstraintTypedDict(TypedDict):
    type: InputDatadogAgentType
    port: float
    r"""Port to listen on"""
    send_to_routes: NotRequired[bool]
...
class InputDatadogAgentSendToRoutesFalseWithConnectionsConstraint(BaseModel):
    type: InputDatadogAgentType
...
class InputDatadogAgentSendToRoutesTrueWithConnectionsConstraintTypedDict(TypedDict):
    type: InputDatadogAgentType
    port: float
    r"""Port to listen on"""
    send_to_routes: NotRequired[bool]
...
class InputDatadogAgentSendToRoutesTrueWithConnectionsConstraint(BaseModel):
    type: InputDatadogAgentType
