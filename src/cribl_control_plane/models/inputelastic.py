...
class InputElasticPqEnabledFalseConstraintTypedDict(TypedDict):
    type: InputElasticType
    port: float
    r"""Port to listen on"""
    pq_enabled: NotRequired[bool]
...
class InputElasticPqEnabledFalseConstraint(BaseModel):
    type: InputElasticType
...
class InputElasticSendToRoutesTrueConstraintTypedDict(TypedDict):
    type: InputElasticType
    port: float
    r"""Port to listen on"""
    send_to_routes: NotRequired[bool]
...
class InputElasticSendToRoutesTrueConstraint(BaseModel):
    type: InputElasticType
