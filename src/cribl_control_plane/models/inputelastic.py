...
class InputElasticPqEnabledTrueWithPqConstraintTypedDict(TypedDict):
...
class InputElasticPqEnabledTrueWithPqConstraint(BaseModel):
    type: InputElasticType
...
class InputElasticPqEnabledFalseWithPqConstraintTypedDict(TypedDict):
    type: InputElasticType
    port: float
    r"""Port to listen on"""
    pq_enabled: NotRequired[bool]
...
class InputElasticPqEnabledFalseWithPqConstraint(BaseModel):
    type: InputElasticType
...
class InputElasticSendToRoutesFalseWithConnectionsConstraintTypedDict(TypedDict):
    type: InputElasticType
    port: float
    r"""Port to listen on"""
    send_to_routes: NotRequired[bool]
...
class InputElasticSendToRoutesFalseWithConnectionsConstraint(BaseModel):
    type: InputElasticType
...
class InputElasticSendToRoutesTrueWithConnectionsConstraintTypedDict(TypedDict):
    type: InputElasticType
    port: float
    r"""Port to listen on"""
    send_to_routes: NotRequired[bool]
...
class InputElasticSendToRoutesTrueWithConnectionsConstraint(BaseModel):
    type: InputElasticType
