...
class InputEventhubInputCollectionPart1Type1TypedDict(TypedDict):
...
class InputEventhubInputCollectionPart1Type1(BaseModel):
    type: InputEventhubType
...
class InputEventhubInputCollectionPart0Type1TypedDict(TypedDict):
    type: InputEventhubType
    brokers: List[str]
    r"""List of Event Hubs Kafka brokers to connect to (example: yourdomain.servicebus.windows.net:9093). The hostname can be found in the host portion of the primary or secondary connection string in Shared Access Policies."""
    topics: List[str]
...
class InputEventhubInputCollectionPart0Type1(BaseModel):
    type: InputEventhubType
...
class InputEventhubInputCollectionPart1TypeTypedDict(TypedDict):
    type: InputEventhubType
    brokers: List[str]
    r"""List of Event Hubs Kafka brokers to connect to (example: yourdomain.servicebus.windows.net:9093). The hostname can be found in the host portion of the primary or secondary connection string in Shared Access Policies."""
    topics: List[str]
...
class InputEventhubInputCollectionPart1Type(BaseModel):
    type: InputEventhubType
...
class InputEventhubInputCollectionPart0TypeTypedDict(TypedDict):
    type: InputEventhubType
    brokers: List[str]
    r"""List of Event Hubs Kafka brokers to connect to (example: yourdomain.servicebus.windows.net:9093). The hostname can be found in the host portion of the primary or secondary connection string in Shared Access Policies."""
    topics: List[str]
...
class InputEventhubInputCollectionPart0Type(BaseModel):
    type: InputEventhubType
