...
class InputExtrahopRevealx360Type(str, Enum):
    r"""Source type identifier."""

    EXTRAHOP_REVEALX_360 = "extrahop_revealx_360"


class InputExtrahopRevealx360InputTypedDict(TypedDict):
    type: InputExtrahopRevealx360Type
    r"""Source type identifier."""
    host: str
...
class InputExtrahopRevealx360Input(BaseModel):
    type: InputExtrahopRevealx360Type
    r"""Source type identifier."""
...
try:
    InputExtrahopRevealx360Input.model_rebuild()
except NameError:
    pass
