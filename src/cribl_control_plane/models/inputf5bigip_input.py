...
class InputF5BigIPType(str, Enum):
    r"""Source type identifier."""

    F5_BIG_IP = "f5_big_ip"


class InputF5BigIPInputTypedDict(TypedDict):
    type: InputF5BigIPType
    r"""Source type identifier."""
    host: str
...
class InputF5BigIPInput(BaseModel):
    type: InputF5BigIPType
    r"""Source type identifier."""
...
try:
    InputF5BigIPInput.model_rebuild()
except NameError:
    pass
