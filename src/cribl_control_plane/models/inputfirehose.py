...
class InputFirehosePqEnabledFalseWithPqConstraintTypedDict(TypedDict):
    type: InputFirehoseType
    port: float
    r"""Port to listen on"""
    pq_enabled: NotRequired[bool]
...
class InputFirehosePqEnabledFalseWithPqConstraint(BaseModel):
    type: InputFirehoseType
...
class InputFirehoseSendToRoutesTrueWithConnectionsConstraintTypedDict(TypedDict):
    type: InputFirehoseType
    port: float
    r"""Port to listen on"""
    send_to_routes: NotRequired[bool]
...
class InputFirehoseSendToRoutesTrueWithConnectionsConstraint(BaseModel):
    type: InputFirehoseType
