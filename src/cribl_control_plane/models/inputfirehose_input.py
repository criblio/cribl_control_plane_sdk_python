...
class InputFirehoseAuthTokensExtTypedDict(TypedDict):
    token: str
...
class InputFirehoseAuthTokensExt(BaseModel):
    token: str
    r"""Shared secret to be provided by any client (Authorization: <token>)"""
...
class InputFirehoseInputTypedDict(TypedDict):
    ...
    auth_tokens_ext: NotRequired[List[InputFirehoseAuthTokensExtTypedDict]]
    r"""Shared secrets to be provided by any client (Authorization: <token>). If empty, unauthorized access is permitted."""
    description: NotRequired[str]
...
class InputFirehoseInput(BaseModel):
    type: InputFirehoseType
    r"""Source type identifier."""
    ...
    auth_tokens_ext: Annotated[
        Optional[List[InputFirehoseAuthTokensExt]],
...
try:
    InputFirehoseAuthTokensExt.model_rebuild()
except NameError:
    pass
try:
    InputFirehoseInput.model_rebuild()
except NameError:
    pass
