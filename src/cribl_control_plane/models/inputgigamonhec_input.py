...
class InputGigamonHecType(str, Enum):
    r"""Source type identifier."""

    GIGAMON_HEC = "gigamon_hec"


class InputGigamonHecInputTypedDict(TypedDict):
    type: InputGigamonHecType
    r"""Source type identifier."""
    host: str
...
class InputGigamonHecInput(BaseModel):
    type: InputGigamonHecType
    r"""Source type identifier."""
...
try:
    InputGigamonHecInput.model_rebuild()
except NameError:
    pass
