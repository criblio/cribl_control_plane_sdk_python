...
class InputHashicorpHcpVaultDedicatedType(str, Enum):
    r"""Source type identifier."""

    HASHICORP_HCP_VAULT_DEDICATED = "hashicorp_hcp_vault_dedicated"


class InputHashicorpHcpVaultDedicatedInputTypedDict(TypedDict):
    type: InputHashicorpHcpVaultDedicatedType
    r"""Source type identifier."""
    host: str
...
class InputHashicorpHcpVaultDedicatedInput(BaseModel):
    type: InputHashicorpHcpVaultDedicatedType
    r"""Source type identifier."""
...
try:
    InputHashicorpHcpVaultDedicatedInput.model_rebuild()
except NameError:
    pass
