...
class InputHTTPHTTP4TypedDict(TypedDict):
    type: TypeHTTPOption
    pq: PqTypeTypedDict
    port: float
    r"""Port to listen on"""
...
class InputHTTPHTTP4(BaseModel):
    type: TypeHTTPOption
...
class InputHTTPHTTP3TypedDict(TypedDict):
    type: TypeHTTPOption
    port: float
    r"""Port to listen on"""
    pq_enabled: NotRequired[bool]
...
class InputHTTPHTTP3(BaseModel):
    type: TypeHTTPOption
...
class InputHTTPHTTP2TypedDict(TypedDict):
    type: TypeHTTPOption
...
class InputHTTPHTTP2(BaseModel):
    type: TypeHTTPOption
...
class InputHTTPHTTP1TypedDict(TypedDict):
    type: TypeHTTPOption
    port: float
    r"""Port to listen on"""
    send_to_routes: NotRequired[bool]
...
class InputHTTPHTTP1(BaseModel):
    type: TypeHTTPOption
...
InputHTTP = TypeAliasType(
    "InputHTTP", Union[InputHTTPHTTP1, InputHTTPHTTP2, InputHTTPHTTP3, InputHTTPHTTP4]
)
