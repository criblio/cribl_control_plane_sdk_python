...
class InputHTTPInputHTTPAuthTypeSecretConstraintTypedDict(TypedDict):
...
class InputHTTPInputHTTPAuthTypeSecretConstraint(BaseModel):
    auth_type: Annotated[
...
class InputHTTPInputHTTPAuthTokensExtItemsTypeTypedDict(TypedDict):
    token: str
    r"""Shared secret to be provided by any client (Authorization: <token>)"""
...
class InputHTTPInputHTTPAuthTokensExtItemsType(BaseModel):
    token: str
    r"""Shared secret to be provided by any client (Authorization: <token>)"""
...
InputHTTPAuthTokensExtTypedDict = TypeAliasType(
    "InputHTTPAuthTokensExtTypedDict",
    Union[
        InputHTTPInputHTTPAuthTokensExtItemsTypeTypedDict,
        InputHTTPInputHTTPAuthTypeSecretConstraintTypedDict,
    ],
)


InputHTTPAuthTokensExt = TypeAliasType(
    "InputHTTPAuthTokensExt",
    Union[
        InputHTTPInputHTTPAuthTokensExtItemsType,
        InputHTTPInputHTTPAuthTypeSecretConstraint,
    ],
)


class InputHTTPInputTypedDict(TypedDict):
    type: InputHTTPType
    r"""Source type identifier."""
    host: str
...
class InputHTTPInput(BaseModel):
    type: InputHTTPType
    r"""Source type identifier."""
...
try:
    InputHTTPInputHTTPAuthTypeSecretConstraint.model_rebuild()
except NameError:
    pass
try:
    InputHTTPInputHTTPAuthTokensExtItemsType.model_rebuild()
except NameError:
    pass
try:
    InputHTTPInput.model_rebuild()
except NameError:
    pass
