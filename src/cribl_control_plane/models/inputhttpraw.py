...
class InputHTTPRawPqEnabledTrueWithPqConstraintTypedDict(TypedDict):
...
class InputHTTPRawPqEnabledTrueWithPqConstraint(BaseModel):
    type: InputHTTPRawType
...
class InputHTTPRawPqEnabledFalseWithPqConstraintTypedDict(TypedDict):
    type: InputHTTPRawType
    port: float
    r"""Port to listen on"""
    pq_enabled: NotRequired[bool]
...
class InputHTTPRawPqEnabledFalseWithPqConstraint(BaseModel):
    type: InputHTTPRawType
...
class InputHTTPRawSendToRoutesFalseWithConnectionsConstraintTypedDict(TypedDict):
    type: InputHTTPRawType
    port: float
    r"""Port to listen on"""
    send_to_routes: NotRequired[bool]
...
class InputHTTPRawSendToRoutesFalseWithConnectionsConstraint(BaseModel):
    type: InputHTTPRawType
...
class InputHTTPRawSendToRoutesTrueWithConnectionsConstraintTypedDict(TypedDict):
    type: InputHTTPRawType
    port: float
    r"""Port to listen on"""
    send_to_routes: NotRequired[bool]
...
class InputHTTPRawSendToRoutesTrueWithConnectionsConstraint(BaseModel):
    type: InputHTTPRawType
...
InputHTTPRawTypedDict = TypeAliasType(
