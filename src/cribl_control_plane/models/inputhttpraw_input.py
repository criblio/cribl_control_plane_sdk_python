...
class InputHTTPRawInputHTTPAuthTypeSecretConstraintTypedDict(TypedDict):
...
class InputHTTPRawInputHTTPAuthTypeSecretConstraint(BaseModel):
    auth_type: Annotated[
...
InputHTTPRawAuthTokensExtUnionTypedDict = TypeAliasType(
    "InputHTTPRawAuthTokensExtUnionTypedDict",
    Union[
        InputHTTPRawAuthTokensExtTypedDict,
        InputHTTPRawInputHTTPAuthTypeSecretConstraintTypedDict,
    ],
)


InputHTTPRawAuthTokensExtUnion = TypeAliasType(
    "InputHTTPRawAuthTokensExtUnion",
    Union[InputHTTPRawAuthTokensExt, InputHTTPRawInputHTTPAuthTypeSecretConstraint],
)
...
class InputHTTPRawInputTypedDict(TypedDict):
    ...
    auth_tokens_ext: NotRequired[List[InputHTTPRawAuthTokensExtUnionTypedDict]]
    r"""Shared secrets to be provided by any client (Authorization: <token>). If empty, unauthorized access is permitted."""
...
class InputHTTPRawInput(BaseModel):
    ...
    auth_tokens_ext: Annotated[
        Optional[List[InputHTTPRawAuthTokensExtUnion]],
...
try:
    InputHTTPRawInputHTTPAuthTypeSecretConstraint.model_rebuild()
except NameError:
    pass
try:
    InputHTTPRawAuthTokensExt.model_rebuild()
except NameError:
    pass
try:
    InputHTTPRawInput.model_rebuild()
except NameError:
    pass
