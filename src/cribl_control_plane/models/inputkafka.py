...
class InputKafkaInputCollectionPart1Type1TypedDict(TypedDict):
    type: InputKafkaType
    brokers: List[str]
...
class InputKafkaInputCollectionPart1Type1(BaseModel):
    type: InputKafkaType
...
class InputKafkaInputCollectionPart0Type1TypedDict(TypedDict):
    type: InputKafkaType
    brokers: List[str]
    r"""Enter each Kafka bootstrap server you want to use. Specify the hostname and port (such as mykafkabroker:9092) or just the hostname (in which case @{product} will assign port 9092)."""
    topics: List[str]
...
class InputKafkaInputCollectionPart0Type1(BaseModel):
    type: InputKafkaType
...
class InputKafkaInputCollectionPart1TypeTypedDict(TypedDict):
    type: InputKafkaType
    brokers: List[str]
    r"""Enter each Kafka bootstrap server you want to use. Specify the hostname and port (such as mykafkabroker:9092) or just the hostname (in which case @{product} will assign port 9092)."""
    topics: List[str]
...
class InputKafkaInputCollectionPart1Type(BaseModel):
    type: InputKafkaType
...
class InputKafkaInputCollectionPart0TypeTypedDict(TypedDict):
    type: InputKafkaType
    brokers: List[str]
    r"""Enter each Kafka bootstrap server you want to use. Specify the hostname and port (such as mykafkabroker:9092) or just the hostname (in which case @{product} will assign port 9092)."""
    topics: List[str]
...
class InputKafkaInputCollectionPart0Type(BaseModel):
    type: InputKafkaType
