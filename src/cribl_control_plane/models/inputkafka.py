...
class InputKafkaKafka4TypedDict(TypedDict):
...
class InputKafkaKafka4(BaseModel):
    type: TypeKafkaOption
...
class InputKafkaKafka3TypedDict(TypedDict):
    type: TypeKafkaOption
    brokers: List[str]
    r"""Enter each Kafka bootstrap server you want to use. Specify the hostname and port (such as mykafkabroker:9092) or just the hostname (in which case @{product} will assign port 9092)."""
    topics: List[str]
...
class InputKafkaKafka3(BaseModel):
    type: TypeKafkaOption
...
class InputKafkaKafka2TypedDict(TypedDict):
    type: TypeKafkaOption
...
class InputKafkaKafka2(BaseModel):
    type: TypeKafkaOption
...
class InputKafkaKafka1TypedDict(TypedDict):
    type: TypeKafkaOption
    brokers: List[str]
    r"""Enter each Kafka bootstrap server you want to use. Specify the hostname and port (such as mykafkabroker:9092) or just the hostname (in which case @{product} will assign port 9092)."""
    topics: List[str]
...
class InputKafkaKafka1(BaseModel):
    type: TypeKafkaOption
...
InputKafka = TypeAliasType(
    "InputKafka",
    Union[InputKafkaKafka1, InputKafkaKafka2, InputKafkaKafka3, InputKafkaKafka4],
)
