...
class InputMimecastHecType(str, Enum):
    r"""Source type identifier."""

    MIMECAST_HEC = "mimecast_hec"


class InputMimecastHecInputTypedDict(TypedDict):
    type: InputMimecastHecType
    r"""Source type identifier."""
    host: str
...
class InputMimecastHecInput(BaseModel):
    type: InputMimecastHecType
    r"""Source type identifier."""
...
try:
    InputMimecastHecInput.model_rebuild()
except NameError:
    pass
