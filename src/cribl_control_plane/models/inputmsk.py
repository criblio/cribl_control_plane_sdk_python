...
class InputMskMsk7TypedDict(TypedDict):
    type: TypeMskOption
    brokers: List[str]
...
class InputMskMsk6TypedDict(TypedDict):
    type: TypeMskOption
    brokers: List[str]
    r"""Enter each Kafka bootstrap server you want to use. Specify the hostname and port (such as mykafkabroker:9092) or just the hostname (in which case @{product} will assign port 9092)."""
    topics: List[str]
...
class InputMskMsk5TypedDict(TypedDict):
    type: TypeMskOption
    brokers: List[str]
    r"""Enter each Kafka bootstrap server you want to use. Specify the hostname and port (such as mykafkabroker:9092) or just the hostname (in which case @{product} will assign port 9092)."""
    topics: List[str]
...
class InputMskMsk4TypedDict(TypedDict):
    type: TypeMskOption
    pq: PqTypeTypedDict
    brokers: List[str]
    r"""Enter each Kafka bootstrap server you want to use. Specify the hostname and port (such as mykafkabroker:9092) or just the hostname (in which case @{product} will assign port 9092)."""
...
class InputMskMsk3TypedDict(TypedDict):
    type: TypeMskOption
    brokers: List[str]
    r"""Enter each Kafka bootstrap server you want to use. Specify the hostname and port (such as mykafkabroker:9092) or just the hostname (in which case @{product} will assign port 9092)."""
    topics: List[str]
...
class InputMskMsk2TypedDict(TypedDict):
    type: TypeMskOption
...
class InputMskMsk1TypedDict(TypedDict):
    type: TypeMskOption
    brokers: List[str]
    r"""Enter each Kafka bootstrap server you want to use. Specify the hostname and port (such as mykafkabroker:9092) or just the hostname (in which case @{product} will assign port 9092)."""
    topics: List[str]
