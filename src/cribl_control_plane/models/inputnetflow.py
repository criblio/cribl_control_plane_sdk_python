...
class InputNetflowNetflow4TypedDict(TypedDict):
...
class InputNetflowNetflow4(BaseModel):
    type: TypeNetflowOption
...
class InputNetflowNetflow3TypedDict(TypedDict):
    type: TypeNetflowOption
    pq_enabled: NotRequired[bool]
    r"""Use a disk queue to minimize data loss when connected services block. See [Cribl Docs](https://docs.cribl.io/stream/persistent-queues) for PQ defaults (Cribl-managed Cloud Workers) and configuration options (on-prem and hybrid Workers)."""
    id: NotRequired[str]
...
class InputNetflowNetflow3(BaseModel):
    type: TypeNetflowOption
...
class InputNetflowNetflow2TypedDict(TypedDict):
    type: TypeNetflowOption
...
class InputNetflowNetflow2(BaseModel):
    type: TypeNetflowOption
...
class InputNetflowNetflow1TypedDict(TypedDict):
    type: TypeNetflowOption
    send_to_routes: NotRequired[bool]
    r"""Select whether to send data to Routes, or directly to Destinations."""
    id: NotRequired[str]
...
class InputNetflowNetflow1(BaseModel):
    type: TypeNetflowOption
