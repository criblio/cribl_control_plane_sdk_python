...
class InputPingIdentityPingoneType(str, Enum):
    r"""Source type identifier."""

    PING_IDENTITY_PINGONE = "ping_identity_pingone"


class InputPingIdentityPingoneInputTypedDict(TypedDict):
    type: InputPingIdentityPingoneType
    r"""Source type identifier."""
    host: str
...
class InputPingIdentityPingoneInput(BaseModel):
    type: InputPingIdentityPingoneType
    r"""Source type identifier."""
...
try:
    InputPingIdentityPingoneInput.model_rebuild()
except NameError:
    pass
