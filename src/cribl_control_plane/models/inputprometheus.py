...
class InputPrometheusInputCollectionPart1Type1TypedDict(TypedDict):
...
class InputPrometheusInputCollectionPart1Type1(BaseModel):
    type: InputPrometheusType
...
class InputPrometheusInputCollectionPart0Type1TypedDict(TypedDict):
    type: InputPrometheusType
    pq_enabled: NotRequired[bool]
    r"""Use a disk queue to minimize data loss when connected services block. See [Cribl Docs](https://docs.cribl.io/stream/persistent-queues) for PQ defaults (Cribl-managed Cloud Workers) and configuration options (on-prem and hybrid Workers)."""
    id: NotRequired[str]
...
class InputPrometheusInputCollectionPart0Type1(BaseModel):
    type: InputPrometheusType
...
class InputPrometheusInputCollectionPart1TypeTypedDict(TypedDict):
    type: InputPrometheusType
    send_to_routes: NotRequired[bool]
    r"""Select whether to send data to Routes, or directly to Destinations."""
    connections: NotRequired[List[ItemsTypeConnectionsTypedDict]]
...
class InputPrometheusInputCollectionPart1Type(BaseModel):
    type: InputPrometheusType
...
class InputPrometheusInputCollectionPart0TypeTypedDict(TypedDict):
    type: InputPrometheusType
    send_to_routes: NotRequired[bool]
    r"""Select whether to send data to Routes, or directly to Destinations."""
    id: NotRequired[str]
...
class InputPrometheusInputCollectionPart0Type(BaseModel):
    type: InputPrometheusType
