...
class InputRawUDPType4(str, Enum):
    RAW_UDP = "raw_udp"


class InputRawUDPRawUDP4TypedDict(TypedDict):
...
class InputRawUDPRawUDP4(BaseModel):
    type: InputRawUDPType4
...
class InputRawUDPType3(str, Enum):
    RAW_UDP = "raw_udp"


class InputRawUDPRawUDP3TypedDict(TypedDict):
...
class InputRawUDPRawUDP3(BaseModel):
    type: InputRawUDPType3
...
class InputRawUDPType2(str, Enum):
    RAW_UDP = "raw_udp"


class InputRawUDPRawUDP2TypedDict(TypedDict):
...
class InputRawUDPRawUDP2(BaseModel):
    type: InputRawUDPType2
...
class InputRawUDPType1(str, Enum):
    RAW_UDP = "raw_udp"


class InputRawUDPRawUDP1TypedDict(TypedDict):
...
class InputRawUDPRawUDP1(BaseModel):
    type: InputRawUDPType1
...
InputRawUDP = TypeAliasType(
    "InputRawUDP",
    Union[
        InputRawUDPRawUDP1, InputRawUDPRawUDP2, InputRawUDPRawUDP3, InputRawUDPRawUDP4
    ],
)
