...
from .inputresponse_inputloki_type import (
    InputResponseInputCloudChangeFirehose,
    InputResponseInputCloudChangeFirehoseTypedDict,
...
from .inputresponse_inputopentelemetry_type import (
    ...
    InputResponseInputCloudChangeEvent,
    InputResponseInputCloudChangeEventTypedDict,
    ...
    InputResponseInputNetskope,
    InputResponseInputNetskopeTypedDict,
    ...
    InputResponseInputSalesforce,
    InputResponseInputSalesforceTypedDict,
...
class InputResponseInputHTTPInputHTTPAuthTypeSecretConstraintTypedDict(TypedDict):
...
class InputResponseInputHTTPInputHTTPAuthTypeSecretConstraint(BaseModel):
    auth_type: Annotated[
...
class InputResponseInputHTTPInputHTTPAuthTokensExtItemsTypeTypedDict(TypedDict):
    token: str
    r"""Shared secret to be provided by any client (Authorization: <token>)"""
    auth_type: NotRequired[AuthenticationMethodOptionsAuthTokensExtItems]
    r"""Select Manual to enter an auth token directly, or select Secret to use a text secret to authenticate"""
...
class InputResponseInputHTTPInputHTTPAuthTokensExtItemsType(BaseModel):
    token: str
    r"""Shared secret to be provided by any client (Authorization: <token>)"""
...
InputResponseInputHTTPAuthTokensExtTypedDict = TypeAliasType(
...
InputResponseInputHTTPAuthTokensExt = TypeAliasType(
    "InputResponseInputHTTPAuthTokensExt",
    Union[
...
class InputResponseInputHTTPTypedDict(TypedDict):
    ...
    metadata: NotRequired[List[MetadataConfInputCollectionTypedDict]]
    r"""Fields to add to events from this input"""
    auth_tokens_ext: NotRequired[List[InputResponseInputHTTPAuthTokensExtTypedDict]]
    r"""Shared secrets to be provided by any client (Authorization: <token>). If empty, unauthorized access is permitted."""
    description: NotRequired[str]
    r"""Optional description for this configuration."""
    template_environment: NotRequired[str]
...
class InputResponseInputHTTP(BaseModel):
    ...
    auth_tokens_ext: Annotated[
        Optional[List[InputResponseInputHTTPAuthTokensExt]],
...
_INPUT_RESPONSE_VARIANTS: dict[str, Any] = {
    ...
    "cloud_change_firehose": InputResponseInputCloudChangeFirehose,
    ...
    "cloud_change_event": InputResponseInputCloudChangeEvent,
    ...
    "salesforce": InputResponseInputSalesforce,
    ...
    "netskope": InputResponseInputNetskope,
}
...
try:
    ...
    pass
try:
    InputResponseInputHTTPInputHTTPAuthTypeSecretConstraint.model_rebuild()
except NameError:
    pass
try:
