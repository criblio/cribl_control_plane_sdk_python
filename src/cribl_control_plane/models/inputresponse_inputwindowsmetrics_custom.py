...
class InputResponseInputS3InventoryType(str, Enum):
    r"""Connector type identifier."""
...
class InputResponseInputS3InventoryTypedDict(TypedDict):
    type: InputResponseInputS3InventoryType
    r"""Connector type identifier."""
    queue_name: str
    r"""The name, URL, or ARN of the SQS queue to read notifications from. When a non-AWS URL is specified, format must be: '{url}/myQueueName'. Example: 'https://host:port/myQueueName'. Value must be a JavaScript expression (which can evaluate to a constant value), enclosed in quotes or backticks. Can be evaluated only at init time. Example referencing a Global Variable: `https://host:port/myQueue-${C.vars.myVar}`."""
    id: NotRequired[str]
...
class InputResponseInputMetricsType(str, Enum):
    r"""Connector type identifier."""
...
class InputResponseInputMetricsTypedDict(TypedDict):
    type: InputResponseInputMetricsType
    r"""Connector type identifier."""
    host: str
    r"""Address to bind on. For IPv4 (all addresses), use the default '0.0.0.0'. For IPv6, enter '::' (all addresses) or specify an IP address."""
    id: NotRequired[str]
...
class InputResponseInputCriblmetricsType(str, Enum):
    r"""Connector type identifier."""
...
class InputResponseInputCriblmetricsTypedDict(TypedDict):
    type: InputResponseInputCriblmetricsType
    r"""Connector type identifier."""
    id: NotRequired[str]
    r"""Unique ID for this input"""
    disabled: NotRequired[bool]
...
class InputResponseInputHTTPRawType(str, Enum):
    r"""Source type identifier."""
...
class InputResponseInputHTTPRawTypedDict(TypedDict):
    type: InputResponseInputHTTPRawType
    r"""Source type identifier."""
    host: str
    r"""Address to bind on. Defaults to 0.0.0.0 (all addresses)."""
    port: float
...
class InputResponseInputDatagenType(str, Enum):
    r"""Connector type identifier."""
...
class InputResponseInputDatagenTypedDict(TypedDict):
    type: InputResponseInputDatagenType
    r"""Connector type identifier."""
...
class InputResponseInputDatadogAgentType(str, Enum):
    r"""Source type identifier."""

    DATADOG_AGENT = "datadog_agent"


class InputResponseSamplingRuleTypedDict(TypedDict):
    service: str
...
class InputResponseSamplingRule(BaseModel):
    service: str
    r"""Datadog service name"""
...
class InputResponseInputDatadogAgentProxyModeTypedDict(TypedDict):
    enabled: bool
...
class InputResponseInputDatadogAgentProxyMode(BaseModel):
    enabled: bool
    r"""Forward key validation requests from the Datadog Agent to the Datadog API. If disabled, Stream handles key validation requests locally by always responding that the key is valid."""
...
class InputResponseInputDatadogAgentTypedDict(TypedDict):
    type: InputResponseInputDatadogAgentType
    r"""Source type identifier."""
    host: str
    r"""Address to bind on. Defaults to 0.0.0.0 (all addresses)."""
    port: float
    ...
    sampling_rules: NotRequired[List[InputResponseSamplingRuleTypedDict]]
    r"""Per-service sampling rate hints. Each row maps to a \"service:<s>,env:<e>\" key in the rate_by_service response sent to tracers."""
    metadata: NotRequired[List[MetadataConfInputCollectionTypedDict]]
    r"""Fields to add to events from this input"""
    proxy_mode: NotRequired[InputResponseInputDatadogAgentProxyModeTypedDict]
    description: NotRequired[str]
    r"""Optional description for this configuration."""
    template_environment: NotRequired[str]
    r"""Binds 'environment' to a variable for dynamic value resolution. Set to variable ID (pack-scoped) or 'cribl.'/'edge.' prefixed ID (group-scoped). Variable value overrides 'environment' at runtime."""
...
class InputResponseInputDatadogAgent(BaseModel):
    ...
    sampling_rules: Annotated[
        Optional[List[InputResponseSamplingRule]], pydantic.Field(alias="samplingRules")
    ] = None
    r"""Per-service sampling rate hints. Each row maps to a \"service:<s>,env:<e>\" key in the rate_by_service response sent to tracers."""
    ...
    proxy_mode: Annotated[
        Optional[InputResponseInputDatadogAgentProxyMode],
...
class InputResponseInputCrowdstrikeType(str, Enum):
    r"""Connector type identifier."""
...
class InputResponseInputCrowdstrikeTypedDict(TypedDict):
    type: InputResponseInputCrowdstrikeType
    r"""Connector type identifier."""
    queue_name: str
    r"""The name, URL, or ARN of the SQS queue to read notifications from. When a non-AWS URL is specified, format must be: '{url}/myQueueName'. Example: 'https://host:port/myQueueName'. Value must be a JavaScript expression (which can evaluate to a constant value), enclosed in quotes or backticks. Can be evaluated only at init time. Example referencing a Global Variable: `https://host:port/myQueue-${C.vars.myVar}`."""
    id: NotRequired[str]
...
class InputResponseInputWindowsMetricsType(str, Enum):
    r"""Connector type identifier."""

    WINDOWS_METRICS = "windows_metrics"


class InputResponseInputWindowsMetricsSystemMode(
    str, Enum, metaclass=utils.OpenEnumMeta
):
...
class InputResponseInputWindowsMetricsSystemTypedDict(TypedDict):
    mode: NotRequired[InputResponseInputWindowsMetricsSystemMode]
    r"""Select the level of details for system metrics"""
    detail: NotRequired[bool]
    r"""Generate metrics for all system information"""


class InputResponseInputWindowsMetricsSystem(BaseModel):
    mode: Optional[InputResponseInputWindowsMetricsSystemMode] = None
    r"""Select the level of details for system metrics"""
    ...
    def serialize_mode(self, value):
        if isinstance(value, str):
            try:
                return models.InputResponseInputWindowsMetricsSystemMode(value)
            except ValueError:
                return value
        return value
...
class InputResponseInputWindowsMetricsCPUMode(str, Enum, metaclass=utils.OpenEnumMeta):
...
class InputResponseInputWindowsMetricsCPUTypedDict(TypedDict):
    mode: NotRequired[InputResponseInputWindowsMetricsCPUMode]
    r"""Select the level of details for CPU metrics"""
...
class InputResponseInputWindowsMetricsCPU(BaseModel):
    mode: Optional[InputResponseInputWindowsMetricsCPUMode] = None
    r"""Select the level of details for CPU metrics"""
    ...
    def serialize_mode(self, value):
        if isinstance(value, str):
            try:
                return models.InputResponseInputWindowsMetricsCPUMode(value)
            except ValueError:
                return value
        return value
...
class InputResponseInputWindowsMetricsMemoryMode(
    str, Enum, metaclass=utils.OpenEnumMeta
):
...
class InputResponseInputWindowsMetricsMemoryTypedDict(TypedDict):
    mode: NotRequired[InputResponseInputWindowsMetricsMemoryMode]
    r"""Select the level of details for memory metrics"""
    detail: NotRequired[bool]
    r"""Generate metrics for all memory states"""


class InputResponseInputWindowsMetricsMemory(BaseModel):
    mode: Optional[InputResponseInputWindowsMetricsMemoryMode] = None
    r"""Select the level of details for memory metrics"""
    ...
    def serialize_mode(self, value):
        if isinstance(value, str):
            try:
                return models.InputResponseInputWindowsMetricsMemoryMode(value)
            except ValueError:
                return value
        return value
...
class InputResponseInputWindowsMetricsNetworkMode(
    str, Enum, metaclass=utils.OpenEnumMeta
):
...
class InputResponseInputWindowsMetricsNetworkTypedDict(TypedDict):
    mode: NotRequired[InputResponseInputWindowsMetricsNetworkMode]
    r"""Select the level of details for network metrics"""
    detail: NotRequired[bool]
...
class InputResponseInputWindowsMetricsNetwork(BaseModel):
    mode: Optional[InputResponseInputWindowsMetricsNetworkMode] = None
    r"""Select the level of details for network metrics"""
    ...
    def serialize_mode(self, value):
        if isinstance(value, str):
            try:
                return models.InputResponseInputWindowsMetricsNetworkMode(value)
            except ValueError:
                return value
        return value
...
class InputResponseInputWindowsMetricsDiskMode(str, Enum, metaclass=utils.OpenEnumMeta):
...
class InputResponseInputWindowsMetricsDiskTypedDict(TypedDict):
...
class InputResponseInputWindowsMetricsDisk(BaseModel):
    mode: Optional[InputResponseInputWindowsMetricsDiskMode] = None
    r"""Select the level of details for disk metrics"""
    ...
    def serialize_mode(self, value):
        if isinstance(value, str):
            try:
                return models.InputResponseInputWindowsMetricsDiskMode(value)
            except ValueError:
                return value
        return value
...
class InputResponseInputWindowsMetricsCustomTypedDict(TypedDict):
    system: NotRequired[InputResponseInputWindowsMetricsSystemTypedDict]
    cpu: NotRequired[InputResponseInputWindowsMetricsCPUTypedDict]
    memory: NotRequired[InputResponseInputWindowsMetricsMemoryTypedDict]
    network: NotRequired[InputResponseInputWindowsMetricsNetworkTypedDict]
    disk: NotRequired[InputResponseInputWindowsMetricsDiskTypedDict]


class InputResponseInputWindowsMetricsCustom(BaseModel):
    system: Optional[InputResponseInputWindowsMetricsSystem] = None

    cpu: Optional[InputResponseInputWindowsMetricsCPU] = None

    memory: Optional[InputResponseInputWindowsMetricsMemory] = None

    network: Optional[InputResponseInputWindowsMetricsNetwork] = None

    disk: Optional[InputResponseInputWindowsMetricsDisk] = None
...
try:
    ...
    pass
try:
    InputResponseInputDatadogAgentProxyMode.model_rebuild()
except NameError:
    pass
try:
...
try:
    ...
    pass
try:
    InputResponseInputWindowsMetricsCPU.model_rebuild()
except NameError:
    pass
try:
    InputResponseInputWindowsMetricsNetwork.model_rebuild()
except NameError:
    pass
try:
    InputResponseInputWindowsMetricsDisk.model_rebuild()
except NameError:
    pass
