...
class InputResponseEndpointName(str, Enum, metaclass=utils.OpenEnumMeta):
...
class InputResponseContentConfigAnthropicComplianceTypedDict(TypedDict):
    content_type: InputResponseEndpointName
    cron_schedule: str
    r"""Schedule on which to run this collection job"""
...
class InputResponseContentConfigAnthropicCompliance(BaseModel):
    content_type: Annotated[
        InputResponseEndpointName, pydantic.Field(alias="contentType")
    ]
    ...
    def serialize_content_type(self, value):
        if isinstance(value, str):
            try:
                return models.InputResponseEndpointName(value)
            except ValueError:
                return value
        return value
