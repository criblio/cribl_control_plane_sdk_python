...
class InputResponseInputOpenTelemetryAuthenticationType(
    str, Enum, metaclass=utils.OpenEnumMeta
):
...
class InputResponseInputOpenTelemetryTypedDict(TypedDict):
    type: InputResponseInputOpenTelemetryType
    r"""Source type identifier."""
    host: str
    r"""Address to bind on. Defaults to 0.0.0.0 (all addresses)."""
    port: float
    ...
    r"""The version of OTLP Protobuf definitions to use when interpreting received data"""
    auth_type: NotRequired[InputResponseInputOpenTelemetryAuthenticationType]
    r"""OpenTelemetry authentication type"""
...
class InputResponseInputOpenTelemetry(BaseModel):
    ...
    auth_type: Annotated[
        Optional[InputResponseInputOpenTelemetryAuthenticationType],
        pydantic.Field(alias="authType"),
    ] = None
    r"""OpenTelemetry authentication type"""
    ...
    def serialize_auth_type(self, value):
        if isinstance(value, str):
            try:
                return models.InputResponseInputOpenTelemetryAuthenticationType(value)
            except ValueError:
                return value
        return value
...
class InputResponseAuthenticationProtocol(str, Enum, metaclass=utils.OpenEnumMeta):
...
class InputResponseV3AuthenticationKeyType(str, Enum, metaclass=utils.OpenEnumMeta):
...
class InputResponsePrivacyProtocol(str, Enum, metaclass=utils.OpenEnumMeta):
    r"""Privacy protocol"""
...
class InputResponseV3PrivacyKeyType(str, Enum, metaclass=utils.OpenEnumMeta):
    r"""Select Manual to enter the key directly, or Secret to use a stored text secret"""
...
class InputResponseV3UserTypedDict(TypedDict):
    name: str
    r"""V3 name"""
    auth_protocol: NotRequired[InputResponseAuthenticationProtocol]
    r"""Authentication protocol"""
    auth_key_type: NotRequired[InputResponseV3AuthenticationKeyType]
    r"""Select Manual to enter the key directly, or Secret to use a stored text secret"""
    auth_key: NotRequired[str]
    r"""V3 authentication key"""
    auth_key_secret: NotRequired[str]
    r"""Select or create a stored text secret"""
    priv_protocol: NotRequired[InputResponsePrivacyProtocol]
    r"""Privacy protocol"""
    priv_key_type: NotRequired[InputResponseV3PrivacyKeyType]
    r"""Select Manual to enter the key directly, or Secret to use a stored text secret"""
...
class InputResponseV3User(BaseModel):
    ...
    auth_protocol: Annotated[
        Optional[InputResponseAuthenticationProtocol],
        pydantic.Field(alias="authProtocol"),
    ] = None
    r"""Authentication protocol"""

    auth_key_type: Annotated[
        Optional[InputResponseV3AuthenticationKeyType],
    ...
    priv_protocol: Annotated[
        Optional[InputResponsePrivacyProtocol], pydantic.Field(alias="privProtocol")
    ] = None
    r"""Privacy protocol"""

    priv_key_type: Annotated[
        Optional[InputResponseV3PrivacyKeyType], pydantic.Field(alias="privKeyType")
    ] = None
    r"""Select Manual to enter the key directly, or Secret to use a stored text secret"""
    ...
    def serialize_auth_protocol(self, value):
        if isinstance(value, str):
            try:
                return models.InputResponseAuthenticationProtocol(value)
            except ValueError:
                return value
        return value
    ...
    def serialize_auth_key_type(self, value):
        if isinstance(value, str):
            try:
                return models.InputResponseV3AuthenticationKeyType(value)
            except ValueError:
                return value
        return value
    ...
    def serialize_priv_protocol(self, value):
        if isinstance(value, str):
            try:
                return models.InputResponsePrivacyProtocol(value)
            except ValueError:
                return value
        return value
    ...
    def serialize_priv_key_type(self, value):
        if isinstance(value, str):
            try:
                return models.InputResponseV3PrivacyKeyType(value)
            except ValueError:
                return value
        return value
