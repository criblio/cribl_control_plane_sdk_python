...
class InputSailpointHecType(str, Enum):
    r"""Source type identifier."""

    SAILPOINT_HEC = "sailpoint_hec"


class InputSailpointHecInputTypedDict(TypedDict):
    type: InputSailpointHecType
    r"""Source type identifier."""
    host: str
...
class InputSailpointHecInput(BaseModel):
    type: InputSailpointHecType
    r"""Source type identifier."""
...
try:
    InputSailpointHecInput.model_rebuild()
except NameError:
    pass
