...
class InputSecurityLakeSecurityLake9TypedDict(TypedDict):
    tag_after_processing: TagAfterProcessingOptions
...
class InputSecurityLakeSecurityLake9(BaseModel):
    tag_after_processing: Annotated[
        Annotated[TagAfterProcessingOptions, PlainValidator(validate_open_enum(False))],
    ...
    processed_tag_key: Annotated[str, pydantic.Field(alias="processedTagKey")]
    r"""The key for the S3 object tag applied after processing. This field accepts an expression for dynamic generation."""

    processed_tag_value: Annotated[str, pydantic.Field(alias="processedTagValue")]
    r"""The value for the S3 object tag applied after processing. This field accepts an expression for dynamic generation."""
...
class InputSecurityLakeSecurityLake8TypedDict(TypedDict):
    tag_after_processing: TagAfterProcessingOptions
    type: TypeSecurityLakeOption
    queue_name: str
    r"""The name, URL, or ARN of the SQS queue to read notifications from. When a non-AWS URL is specified, format must be: '{url}/myQueueName'. Example: 'https://host:port/myQueueName'. Value must be a JavaScript expression (which can evaluate to a constant value), enclosed in quotes or backticks. Can be evaluated only at init time. Example referencing a Global Variable: `https://host:port/myQueue-${C.vars.myVar}`."""
...
class InputSecurityLakeSecurityLake8(BaseModel):
    tag_after_processing: Annotated[
        Annotated[TagAfterProcessingOptions, PlainValidator(validate_open_enum(False))],
        pydantic.Field(alias="tagAfterProcessing"),
    ]
...
class InputSecurityLakeSecurityLake7TypedDict(TypedDict):
    type: TypeSecurityLakeOption
    queue_name: str
    r"""The name, URL, or ARN of the SQS queue to read notifications from. When a non-AWS URL is specified, format must be: '{url}/myQueueName'. Example: 'https://host:port/myQueueName'. Value must be a JavaScript expression (which can evaluate to a constant value), enclosed in quotes or backticks. Can be evaluated only at init time. Example referencing a Global Variable: `https://host:port/myQueue-${C.vars.myVar}`."""
    aws_secret: str
...
class InputSecurityLakeSecurityLake7(BaseModel):
    type: TypeSecurityLakeOption
...
class InputSecurityLakeSecurityLake6TypedDict(TypedDict):
    type: TypeSecurityLakeOption
    queue_name: str
    r"""The name, URL, or ARN of the SQS queue to read notifications from. When a non-AWS URL is specified, format must be: '{url}/myQueueName'. Example: 'https://host:port/myQueueName'. Value must be a JavaScript expression (which can evaluate to a constant value), enclosed in quotes or backticks. Can be evaluated only at init time. Example referencing a Global Variable: `https://host:port/myQueue-${C.vars.myVar}`."""
    aws_api_key: str
...
class InputSecurityLakeSecurityLake6(BaseModel):
    type: TypeSecurityLakeOption
...
class InputSecurityLakeSecurityLake5TypedDict(TypedDict):
    type: TypeSecurityLakeOption
    queue_name: str
    r"""The name, URL, or ARN of the SQS queue to read notifications from. When a non-AWS URL is specified, format must be: '{url}/myQueueName'. Example: 'https://host:port/myQueueName'. Value must be a JavaScript expression (which can evaluate to a constant value), enclosed in quotes or backticks. Can be evaluated only at init time. Example referencing a Global Variable: `https://host:port/myQueue-${C.vars.myVar}`."""
    aws_authentication_method: NotRequired[AwsAuthenticationMethodOptions]
...
class InputSecurityLakeSecurityLake5(BaseModel):
    type: TypeSecurityLakeOption
...
class InputSecurityLakeSecurityLake4TypedDict(TypedDict):
    type: TypeSecurityLakeOption
    pq: PqTypeTypedDict
    queue_name: str
    r"""The name, URL, or ARN of the SQS queue to read notifications from. When a non-AWS URL is specified, format must be: '{url}/myQueueName'. Example: 'https://host:port/myQueueName'. Value must be a JavaScript expression (which can evaluate to a constant value), enclosed in quotes or backticks. Can be evaluated only at init time. Example referencing a Global Variable: `https://host:port/myQueue-${C.vars.myVar}`."""
...
class InputSecurityLakeSecurityLake4(BaseModel):
    type: TypeSecurityLakeOption
...
class InputSecurityLakeSecurityLake3TypedDict(TypedDict):
    type: TypeSecurityLakeOption
    queue_name: str
    r"""The name, URL, or ARN of the SQS queue to read notifications from. When a non-AWS URL is specified, format must be: '{url}/myQueueName'. Example: 'https://host:port/myQueueName'. Value must be a JavaScript expression (which can evaluate to a constant value), enclosed in quotes or backticks. Can be evaluated only at init time. Example referencing a Global Variable: `https://host:port/myQueue-${C.vars.myVar}`."""
    pq_enabled: NotRequired[bool]
...
class InputSecurityLakeSecurityLake3(BaseModel):
    type: TypeSecurityLakeOption
...
class InputSecurityLakeSecurityLake2TypedDict(TypedDict):
    type: TypeSecurityLakeOption
...
class InputSecurityLakeSecurityLake2(BaseModel):
    type: TypeSecurityLakeOption
...
class InputSecurityLakeSecurityLake1TypedDict(TypedDict):
    type: TypeSecurityLakeOption
    queue_name: str
    r"""The name, URL, or ARN of the SQS queue to read notifications from. When a non-AWS URL is specified, format must be: '{url}/myQueueName'. Example: 'https://host:port/myQueueName'. Value must be a JavaScript expression (which can evaluate to a constant value), enclosed in quotes or backticks. Can be evaluated only at init time. Example referencing a Global Variable: `https://host:port/myQueue-${C.vars.myVar}`."""
    send_to_routes: NotRequired[bool]
...
class InputSecurityLakeSecurityLake1(BaseModel):
    type: TypeSecurityLakeOption
