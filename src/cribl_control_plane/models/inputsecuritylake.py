...
class InputSecurityLakeInputCollectionPart1Type1TypedDict(TypedDict):
...
class InputSecurityLakeInputCollectionPart1Type1(BaseModel):
    type: InputSecurityLakeType
...
class InputSecurityLakeInputCollectionPart0Type1TypedDict(TypedDict):
    type: InputSecurityLakeType
    queue_name: str
    r"""The name, URL, or ARN of the SQS queue to read notifications from. When a non-AWS URL is specified, format must be: '{url}/myQueueName'. Example: 'https://host:port/myQueueName'. Value must be a JavaScript expression (which can evaluate to a constant value), enclosed in quotes or backticks. Can be evaluated only at init time. Example referencing a Global Variable: `https://host:port/myQueue-${C.vars.myVar}`."""
    pq_enabled: NotRequired[bool]
...
class InputSecurityLakeInputCollectionPart0Type1(BaseModel):
    type: InputSecurityLakeType
...
class InputSecurityLakeInputCollectionPart1TypeTypedDict(TypedDict):
    type: InputSecurityLakeType
    queue_name: str
    r"""The name, URL, or ARN of the SQS queue to read notifications from. When a non-AWS URL is specified, format must be: '{url}/myQueueName'. Example: 'https://host:port/myQueueName'. Value must be a JavaScript expression (which can evaluate to a constant value), enclosed in quotes or backticks. Can be evaluated only at init time. Example referencing a Global Variable: `https://host:port/myQueue-${C.vars.myVar}`."""
    send_to_routes: NotRequired[bool]
...
class InputSecurityLakeInputCollectionPart1Type(BaseModel):
    type: InputSecurityLakeType
...
class InputSecurityLakeInputCollectionPart0TypeTypedDict(TypedDict):
    type: InputSecurityLakeType
    queue_name: str
    r"""The name, URL, or ARN of the SQS queue to read notifications from. When a non-AWS URL is specified, format must be: '{url}/myQueueName'. Example: 'https://host:port/myQueueName'. Value must be a JavaScript expression (which can evaluate to a constant value), enclosed in quotes or backticks. Can be evaluated only at init time. Example referencing a Global Variable: `https://host:port/myQueue-${C.vars.myVar}`."""
    send_to_routes: NotRequired[bool]
...
class InputSecurityLakeInputCollectionPart0Type(BaseModel):
    type: InputSecurityLakeType
