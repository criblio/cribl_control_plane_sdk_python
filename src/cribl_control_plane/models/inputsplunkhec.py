...
class InputSplunkHecSplunkHec4TypedDict(TypedDict):
...
class InputSplunkHecSplunkHec4(BaseModel):
    type: TypeSplunkHecOption
...
class InputSplunkHecSplunkHec3TypedDict(TypedDict):
    type: TypeSplunkHecOption
    port: float
    r"""Port to listen on"""
    pq_enabled: NotRequired[bool]
...
class InputSplunkHecSplunkHec3(BaseModel):
    type: TypeSplunkHecOption
...
class InputSplunkHecSplunkHec2TypedDict(TypedDict):
    type: TypeSplunkHecOption
...
class InputSplunkHecSplunkHec2(BaseModel):
    type: TypeSplunkHecOption
...
class InputSplunkHecSplunkHec1TypedDict(TypedDict):
    type: TypeSplunkHecOption
    port: float
    r"""Port to listen on"""
    send_to_routes: NotRequired[bool]
...
class InputSplunkHecSplunkHec1(BaseModel):
    type: TypeSplunkHecOption
