...
InputSyslogInputUnionTypedDict = TypeAliasType(
    "InputSyslogInputUnionTypedDict",
    Union[InputSyslogSyslogInput1TypedDict, InputSyslogSyslogInput2TypedDict],
)


InputSyslogInputUnion = TypeAliasType(
    "InputSyslogInputUnion", Union[InputSyslogSyslogInput1, InputSyslogSyslogInput2]
)


try:
    InputSyslogSyslogInput2.model_rebuild()
except NameError:
    pass
try:
    InputSyslogSyslogInput1.model_rebuild()
except NameError:
    pass
