...
class InputTrellixHecType(str, Enum):
    r"""Source type identifier."""

    TRELLIX_HEC = "trellix_hec"


class InputTrellixHecInputTypedDict(TypedDict):
    type: InputTrellixHecType
    r"""Source type identifier."""
    host: str
...
class InputTrellixHecInput(BaseModel):
    type: InputTrellixHecType
    r"""Source type identifier."""
...
try:
    InputTrellixHecInput.model_rebuild()
except NameError:
    pass
