...
class InputTrendMicroVisionOneType(str, Enum):
    r"""Source type identifier."""

    TREND_MICRO_VISION_ONE = "trend_micro_vision_one"


class InputTrendMicroVisionOneInputTypedDict(TypedDict):
    type: InputTrendMicroVisionOneType
    r"""Source type identifier."""
    host: str
...
class InputTrendMicroVisionOneInput(BaseModel):
    type: InputTrendMicroVisionOneType
    r"""Source type identifier."""
...
try:
    InputTrendMicroVisionOneInput.model_rebuild()
except NameError:
    pass
