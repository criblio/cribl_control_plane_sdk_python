...
from .typeoptionsrunnablejobcollectioninput import TypeOptionsRunnableJobCollectionInput
...
class InputTypeRunnableJobCollection(BaseModel):
    ...
    def serialize_type(self, value):
        if isinstance(value, str):
            try:
                return models.TypeOptionsRunnableJobCollectionInput(value)
            except ValueError:
                return value
        return value
...
try:
    InputTypeRunnableJobCollection.model_rebuild()
except NameError:
    pass
