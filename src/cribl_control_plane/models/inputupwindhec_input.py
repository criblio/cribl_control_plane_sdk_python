...
class InputUpwindHecType(str, Enum):
    r"""Source type identifier."""

    UPWIND_HEC = "upwind_hec"


class InputUpwindHecInputTypedDict(TypedDict):
    type: InputUpwindHecType
    r"""Source type identifier."""
    host: str
...
class InputUpwindHecInput(BaseModel):
    type: InputUpwindHecType
    r"""Source type identifier."""
...
try:
    InputUpwindHecInput.model_rebuild()
except NameError:
    pass
