...
class InputVectraAiHecType(str, Enum):
    r"""Source type identifier."""

    VECTRA_AI_HEC = "vectra_ai_hec"


class InputVectraAiHecInputTypedDict(TypedDict):
    type: InputVectraAiHecType
    r"""Source type identifier."""
    host: str
...
class InputVectraAiHecInput(BaseModel):
    type: InputVectraAiHecType
    r"""Source type identifier."""
...
try:
    InputVectraAiHecInput.model_rebuild()
except NameError:
    pass
