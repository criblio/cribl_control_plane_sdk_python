...
class InputWefPqEnabledTrueWithPqConstraintTypedDict(TypedDict):
    type: InputWefType
...
class InputWefPqEnabledTrueWithPqConstraint(BaseModel):
    type: InputWefType
...
class InputWefPqEnabledFalseWithPqConstraintTypedDict(TypedDict):
    type: InputWefType
    subscriptions: List[SubscriptionTypedDict]
    r"""Subscriptions to events on forwarding endpoints"""
    pq_enabled: NotRequired[bool]
...
class InputWefPqEnabledFalseWithPqConstraint(BaseModel):
    type: InputWefType
...
class InputWefSendToRoutesFalseWithConnectionsConstraintTypedDict(TypedDict):
    type: InputWefType
    subscriptions: List[SubscriptionTypedDict]
    r"""Subscriptions to events on forwarding endpoints"""
    send_to_routes: NotRequired[bool]
...
class InputWefSendToRoutesFalseWithConnectionsConstraint(BaseModel):
    type: InputWefType
...
class InputWefSendToRoutesTrueWithConnectionsConstraintTypedDict(TypedDict):
    type: InputWefType
    subscriptions: List[SubscriptionTypedDict]
    r"""Subscriptions to events on forwarding endpoints"""
    send_to_routes: NotRequired[bool]
...
class InputWefSendToRoutesTrueWithConnectionsConstraint(BaseModel):
    type: InputWefType
