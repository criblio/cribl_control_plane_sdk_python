...
class InputWinEventLogsPqEnabledFalseWithPqConstraintTypedDict(TypedDict):
    type: InputWinEventLogsType
    log_names: List[str]
    r"""Enter the event logs to collect. Run \"Get-WinEvent -ListLog *\" in PowerShell to see the available logs."""
    pq_enabled: NotRequired[bool]
...
class InputWinEventLogsPqEnabledFalseWithPqConstraint(BaseModel):
    type: InputWinEventLogsType
...
class InputWinEventLogsSendToRoutesTrueWithConnectionsConstraintTypedDict(TypedDict):
    type: InputWinEventLogsType
    log_names: List[str]
    r"""Enter the event logs to collect. Run \"Get-WinEvent -ListLog *\" in PowerShell to see the available logs."""
    send_to_routes: NotRequired[bool]
...
class InputWinEventLogsSendToRoutesTrueWithConnectionsConstraint(BaseModel):
    type: InputWinEventLogsType
