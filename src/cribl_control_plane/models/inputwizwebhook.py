...
from .authtokensexttype import AuthTokensExtType, AuthTokensExtTypeTypedDict
...
class InputWizWebhookType4(str, Enum):
    WIZ_WEBHOOK = "wiz_webhook"


class InputWizWebhookWizWebhook4TypedDict(TypedDict):
    ...
    auth_tokens_ext: NotRequired[List[AuthTokensExtTypeTypedDict]]
    r"""Shared secrets to be provided by any client (Authorization: <token>). If empty, unauthorized access is permitted."""
    description: NotRequired[str]


class InputWizWebhookWizWebhook4(BaseModel):
    type: InputWizWebhookType4
    ...
    auth_tokens_ext: Annotated[
        Optional[List[AuthTokensExtType]], pydantic.Field(alias="authTokensExt")
    ] = None
    r"""Shared secrets to be provided by any client (Authorization: <token>). If empty, unauthorized access is permitted."""
...
class InputWizWebhookType3(str, Enum):
    WIZ_WEBHOOK = "wiz_webhook"


class InputWizWebhookWizWebhook3TypedDict(TypedDict):
...
class InputWizWebhookWizWebhook3(BaseModel):
    type: InputWizWebhookType3
...
class InputWizWebhookType2(str, Enum):
    WIZ_WEBHOOK = "wiz_webhook"


class InputWizWebhookWizWebhook2TypedDict(TypedDict):
...
class InputWizWebhookWizWebhook2(BaseModel):
    type: InputWizWebhookType2
...
class InputWizWebhookType1(str, Enum):
    WIZ_WEBHOOK = "wiz_webhook"


class InputWizWebhookWizWebhook1TypedDict(TypedDict):
...
class InputWizWebhookWizWebhook1(BaseModel):
    type: InputWizWebhookType1
...
InputWizWebhookTypedDict = TypeAliasType(
