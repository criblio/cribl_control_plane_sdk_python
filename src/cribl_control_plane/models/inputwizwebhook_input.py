...
class InputWizWebhookAuthTokensExt2TypedDict(TypedDict):
...
class InputWizWebhookAuthTokensExt2(BaseModel):
    auth_type: Annotated[
...
class InputWizWebhookAuthTokensExt1TypedDict(TypedDict):
    token: str
    r"""Shared secret to be provided by any client (Authorization: <token>)"""
...
class InputWizWebhookAuthTokensExt1(BaseModel):
    token: str
    r"""Shared secret to be provided by any client (Authorization: <token>)"""
...
InputWizWebhookAuthTokensExtUnionTypedDict = TypeAliasType(
    "InputWizWebhookAuthTokensExtUnionTypedDict",
    Union[
        InputWizWebhookAuthTokensExt1TypedDict, InputWizWebhookAuthTokensExt2TypedDict
    ],
)


InputWizWebhookAuthTokensExtUnion = TypeAliasType(
    "InputWizWebhookAuthTokensExtUnion",
    Union[InputWizWebhookAuthTokensExt1, InputWizWebhookAuthTokensExt2],
)


class InputWizWebhookInputTypedDict(TypedDict):
    ...
    auth_tokens_ext: NotRequired[List[InputWizWebhookAuthTokensExtUnionTypedDict]]
    r"""Shared secrets to be provided by any client (Authorization: <token>). If empty, unauthorized access is permitted."""
    description: NotRequired[str]
...
class InputWizWebhookInput(BaseModel):
    type: InputWizWebhookType
    r"""Source type identifier."""
    ...
    auth_tokens_ext: Annotated[
        Optional[List[InputWizWebhookAuthTokensExtUnion]],
...
try:
    InputWizWebhookAuthTokensExt2.model_rebuild()
except NameError:
    pass
try:
    InputWizWebhookAuthTokensExt1.model_rebuild()
except NameError:
    pass
try:
    InputWizWebhookInput.model_rebuild()
except NameError:
    pass
