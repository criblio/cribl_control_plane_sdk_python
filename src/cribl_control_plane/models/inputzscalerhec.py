...
from .authtokenstype import AuthTokensType, AuthTokensTypeTypedDict
...
class InputZscalerHecType4(str, Enum):
    ZSCALER_HEC = "zscaler_hec"


class InputZscalerHecZscalerHec4TypedDict(TypedDict):
    ...
    auth_tokens: NotRequired[List[AuthTokensTypeTypedDict]]
...
class InputZscalerHecZscalerHec4(BaseModel):
    type: InputZscalerHecType4
    ...
    auth_tokens: Annotated[
        Optional[List[AuthTokensType]], pydantic.Field(alias="authTokens")
    ] = None
    r"""Shared secrets to be provided by any client (Authorization: <token>). If empty, unauthorized access is permitted."""
...
class InputZscalerHecType3(str, Enum):
    ZSCALER_HEC = "zscaler_hec"


class InputZscalerHecZscalerHec3TypedDict(TypedDict):
...
class InputZscalerHecZscalerHec3(BaseModel):
    type: InputZscalerHecType3
...
class InputZscalerHecType2(str, Enum):
    ZSCALER_HEC = "zscaler_hec"


class InputZscalerHecZscalerHec2TypedDict(TypedDict):
...
class InputZscalerHecZscalerHec2(BaseModel):
    type: InputZscalerHecType2
...
class InputZscalerHecType1(str, Enum):
    ZSCALER_HEC = "zscaler_hec"


class InputZscalerHecZscalerHec1TypedDict(TypedDict):
...
class InputZscalerHecZscalerHec1(BaseModel):
    type: InputZscalerHecType1
