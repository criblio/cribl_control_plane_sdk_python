...
class OutputAlibabaCloudS3AuthenticationMethod(str, Enum, metaclass=utils.OpenEnumMeta):
...
class OutputAlibabaCloudS3(BaseModel):
    ...
    def serialize_aws_authentication_method(self, value):
        if isinstance(value, str):
            try:
                return models.OutputAlibabaCloudS3AuthenticationMethod(value)
            except ValueError:
                return value
        return value
...
try:
    OutputAlibabaCloudS3.model_rebuild()
except NameError:
    pass
