...
class OutputAmazonManagedPrometheusTypedDict(TypedDict):
    ...
    r"""Use Assume Role credentials to access AMSP"""
    ...
    r"""Maximum uncompressed size, in KB, of the request body. The 1 MB cap is intentional and protects against data that compresses poorly, since oversized requests fail with a non-retryable 413."""
    ...
    r"""Headers to add to all events. SigV4-managed headers and the Prometheus remote-write protocol version header are generated by this Destination and cannot be configured here."""
...
try:
    OutputAmazonManagedPrometheus.model_rebuild()
except NameError:
    pass
