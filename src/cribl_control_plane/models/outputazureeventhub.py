...
from .sasl1type import Sasl1Type, Sasl1TypeTypedDict
...
class OutputAzureEventhubType2(str, Enum):
    AZURE_EVENTHUB = "azure_eventhub"


class OutputAzureEventhubAzureEventhub2TypedDict(TypedDict):
    ...
    sasl: NotRequired[Sasl1TypeTypedDict]
...
class OutputAzureEventhubAzureEventhub2(BaseModel):
    type: OutputAzureEventhubType2
...
class OutputAzureEventhubType1(str, Enum):
    AZURE_EVENTHUB = "azure_eventhub"


class OutputAzureEventhubAzureEventhub1TypedDict(TypedDict):
...
class OutputAzureEventhubAzureEventhub1(BaseModel):
    type: OutputAzureEventhubType1
...
OutputAzureEventhubTypedDict = TypeAliasType(
...
OutputAzureEventhub = TypeAliasType(
    "OutputAzureEventhub",
    Union[OutputAzureEventhubAzureEventhub1, OutputAzureEventhubAzureEventhub2],
)
