...
class OutputAzureLogsType4(str, Enum):
    AZURE_LOGS = "azure_logs"


class OutputAzureLogsAzureLogs4TypedDict(TypedDict):
...
class OutputAzureLogsAzureLogs4(BaseModel):
    type: OutputAzureLogsType4

    keypair_secret: Annotated[str, pydantic.Field(alias="keypairSecret")]
    r"""Select or create a stored secret that references your access key and secret key"""
...
class OutputAzureLogsType3(str, Enum):
    AZURE_LOGS = "azure_logs"


class OutputAzureLogsAzureLogs3TypedDict(TypedDict):
...
class OutputAzureLogsAzureLogs3(BaseModel):
    type: OutputAzureLogsType3

    workspace_id: Annotated[str, pydantic.Field(alias="workspaceId")]
    r"""Azure Log Analytics Workspace ID. See Azure Dashboard Workspace > Advanced settings."""

    workspace_key: Annotated[str, pydantic.Field(alias="workspaceKey")]
    r"""Azure Log Analytics Workspace Primary or Secondary Shared Key. See Azure Dashboard Workspace > Advanced settings."""
...
class OutputAzureLogsType2(str, Enum):
    AZURE_LOGS = "azure_logs"


class OutputAzureLogsAzureLogs2TypedDict(TypedDict):
...
class OutputAzureLogsAzureLogs2(BaseModel):
    type: OutputAzureLogsType2
...
class OutputAzureLogsType1(str, Enum):
    AZURE_LOGS = "azure_logs"


class OutputAzureLogsAzureLogs1TypedDict(TypedDict):
...
class OutputAzureLogsAzureLogs1(BaseModel):
    type: OutputAzureLogsType1
...
OutputAzureLogsTypedDict = TypeAliasType(
