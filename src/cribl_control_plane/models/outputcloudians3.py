...
class OutputCloudianS3SignatureVersion(str, Enum, metaclass=utils.OpenEnumMeta):
...
class OutputCloudianS3TypedDict(TypedDict):
    ...
    signature_version: NotRequired[OutputCloudianS3SignatureVersion]
    r"""Signature version to use for signing Cloudian requests"""
...
class OutputCloudianS3(BaseModel):
    ...
    signature_version: Annotated[
        Optional[OutputCloudianS3SignatureVersion],
    ...
    def serialize_signature_version(self, value):
        if isinstance(value, str):
            try:
                return models.OutputCloudianS3SignatureVersion(value)
            except ValueError:
                return value
        return value
...
try:
    OutputCloudianS3.model_rebuild()
except NameError:
    pass
