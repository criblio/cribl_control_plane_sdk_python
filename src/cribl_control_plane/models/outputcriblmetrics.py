...
from .authtokenconfoutputcriblhttp import (
    AuthTokenConfOutputCriblHTTP,
    AuthTokenConfOutputCriblHTTPTypedDict,
)
...
from .urlconfoutputcriblhttp import (
...
class OutputCriblMetricsType(str, Enum):
    r"""Connector type identifier."""

    CRIBL_METRICS = "cribl_metrics"


class OutputCriblMetricsPqControlsTypedDict(TypedDict):
    r"""Persistent queue controls."""


class OutputCriblMetricsPqControls(BaseModel):
    r"""Persistent queue controls."""


class OutputCriblMetricsTypedDict(TypedDict):
    type: OutputCriblMetricsType
    r"""Connector type identifier."""
    id: NotRequired[str]
    ...
    r"""Shared secrets to be used by connected environments to authorize connections. These tokens should also be installed in the Cribl HTTP Source on the Cribl Metrics."""
    ...
    pq_controls: NotRequired[OutputCriblMetricsPqControlsTypedDict]
    r"""Persistent queue controls."""
...
class OutputCriblMetrics(BaseModel):
    type: OutputCriblMetricsType
    r"""Connector type identifier."""
    ...
    auth_tokens: Annotated[
        Optional[List[AuthTokenConfOutputCriblHTTP]], pydantic.Field(alias="authTokens")
    ] = None
    r"""Shared secrets to be used by connected environments to authorize connections. These tokens should also be installed in the Cribl HTTP Source on the Cribl Metrics."""
    ...
    pq_controls: Annotated[
        Optional[OutputCriblMetricsPqControls], pydantic.Field(alias="pqControls")
    ] = None
    r"""Persistent queue controls."""
...
try:
    OutputCriblMetrics.model_rebuild()
except NameError:
    pass
