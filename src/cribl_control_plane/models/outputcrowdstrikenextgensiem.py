...
class OutputCrowdstrikeNextGenSiemType4(str, Enum):
    CROWDSTRIKE_NEXT_GEN_SIEM = "crowdstrike_next_gen_siem"


class OutputCrowdstrikeNextGenSiemCrowdstrikeNextGenSiem4TypedDict(TypedDict):
    ...
    format_: NotRequired[Format4Options]
...
class OutputCrowdstrikeNextGenSiemCrowdstrikeNextGenSiem4(BaseModel):
    type: OutputCrowdstrikeNextGenSiemType4
    ...
    format_: Annotated[
        Annotated[Optional[Format4Options], PlainValidator(validate_open_enum(False))],
    ...
    def serialize_format_(self, value):
        if isinstance(value, str):
            try:
                return models.Format4Options(value)
            except ValueError:
                return value
        return value
...
class OutputCrowdstrikeNextGenSiemType3(str, Enum):
    CROWDSTRIKE_NEXT_GEN_SIEM = "crowdstrike_next_gen_siem"


class OutputCrowdstrikeNextGenSiemCrowdstrikeNextGenSiem3TypedDict(TypedDict):
...
class OutputCrowdstrikeNextGenSiemCrowdstrikeNextGenSiem3(BaseModel):
    type: OutputCrowdstrikeNextGenSiemType3
...
class OutputCrowdstrikeNextGenSiemType2(str, Enum):
    CROWDSTRIKE_NEXT_GEN_SIEM = "crowdstrike_next_gen_siem"


class OutputCrowdstrikeNextGenSiemCrowdstrikeNextGenSiem2TypedDict(TypedDict):
...
class OutputCrowdstrikeNextGenSiemCrowdstrikeNextGenSiem2(BaseModel):
    type: OutputCrowdstrikeNextGenSiemType2
...
class OutputCrowdstrikeNextGenSiemType1(str, Enum):
    CROWDSTRIKE_NEXT_GEN_SIEM = "crowdstrike_next_gen_siem"


class OutputCrowdstrikeNextGenSiemCrowdstrikeNextGenSiem1TypedDict(TypedDict):
...
class OutputCrowdstrikeNextGenSiemCrowdstrikeNextGenSiem1(BaseModel):
    type: OutputCrowdstrikeNextGenSiemType1
...
OutputCrowdstrikeNextGenSiemTypedDict = TypeAliasType(
...
OutputCrowdstrikeNextGenSiem = TypeAliasType(
