...
class OutputDellS3SignatureVersion(str, Enum, metaclass=utils.OpenEnumMeta):
...
class OutputDellS3TypedDict(TypedDict):
    ...
    signature_version: NotRequired[OutputDellS3SignatureVersion]
    r"""Signature version to use for signing Dell PowerScale OneFS requests"""
...
class OutputDellS3(BaseModel):
    ...
    signature_version: Annotated[
        Optional[OutputDellS3SignatureVersion], pydantic.Field(alias="signatureVersion")
    ] = None
    r"""Signature version to use for signing Dell PowerScale OneFS requests"""
    ...
    def serialize_signature_version(self, value):
        if isinstance(value, str):
            try:
                return models.OutputDellS3SignatureVersion(value)
            except ValueError:
                return value
        return value
