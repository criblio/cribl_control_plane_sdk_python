...
class OutputDlS3TypedDict(TypedDict):
    ...
    template_partitioning_fields: NotRequired[str]
    r"""Binds 'partitioningFields' to a variable for dynamic value resolution. Set to variable ID (pack-scoped) or 'cribl.'/'edge.' prefixed ID (group-scoped). Variable value overrides 'partitioningFields' at runtime."""
...
class OutputDlS3(BaseModel):
    ...
    template_partitioning_fields: Annotated[
        Optional[str], pydantic.Field(alias="__template_partitioningFields")
    ] = None
    r"""Binds 'partitioningFields' to a variable for dynamic value resolution. Set to variable ID (pack-scoped) or 'cribl.'/'edge.' prefixed ID (group-scoped). Variable value overrides 'partitioningFields' at runtime."""
