...
class OutputDynatraceOtlpType3(str, Enum):
    DYNATRACE_OTLP = "dynatrace_otlp"


class EndpointType3(str, Enum, metaclass=utils.OpenEnumMeta):
...
class OutputDynatraceOtlpDynatraceOtlp3TypedDict(TypedDict):
    ...
    endpoint_type: NotRequired[EndpointType3]
    r"""Select the type of Dynatrace endpoint configured"""
...
class OutputDynatraceOtlpDynatraceOtlp3(BaseModel):
    type: OutputDynatraceOtlpType3
    ...
    endpoint_type: Annotated[
        Annotated[Optional[EndpointType3], PlainValidator(validate_open_enum(False))],
    ...
    def serialize_endpoint_type(self, value):
        if isinstance(value, str):
            try:
                return models.EndpointType3(value)
            except ValueError:
                return value
        return value
...
class OutputDynatraceOtlpType2(str, Enum):
    DYNATRACE_OTLP = "dynatrace_otlp"


class EndpointType2(str, Enum, metaclass=utils.OpenEnumMeta):
    r"""Select the type of Dynatrace endpoint configured"""
...
class OutputDynatraceOtlpDynatraceOtlp2TypedDict(TypedDict):
    ...
    keep_alive: NotRequired[bool]
    r"""Disable to close the connection immediately after sending the outgoing request"""
    endpoint_type: NotRequired[EndpointType2]
    r"""Select the type of Dynatrace endpoint configured"""
    auth_token_name: NotRequired[str]
    description: NotRequired[str]
    reject_unauthorized: NotRequired[bool]
...
class OutputDynatraceOtlpDynatraceOtlp2(BaseModel):
    type: OutputDynatraceOtlpType2
    ...
    endpoint_type: Annotated[
        Annotated[Optional[EndpointType2], PlainValidator(validate_open_enum(False))],
        pydantic.Field(alias="endpointType"),
    ] = EndpointType2.SAAS
    r"""Select the type of Dynatrace endpoint configured"""
    ...
    def serialize_endpoint_type(self, value):
        if isinstance(value, str):
            try:
                return models.EndpointType2(value)
            except ValueError:
                return value
        return value
...
class OutputDynatraceOtlpType1(str, Enum):
    DYNATRACE_OTLP = "dynatrace_otlp"


class EndpointType1(str, Enum, metaclass=utils.OpenEnumMeta):
    r"""Select the type of Dynatrace endpoint configured"""
...
class OutputDynatraceOtlpDynatraceOtlp1TypedDict(TypedDict):
    protocol: TypeHTTPOption
    ...
    keep_alive: NotRequired[bool]
    r"""Disable to close the connection immediately after sending the outgoing request"""
    endpoint_type: NotRequired[EndpointType1]
    r"""Select the type of Dynatrace endpoint configured"""
    auth_token_name: NotRequired[str]
    on_backpressure: NotRequired[OnBackpressureOptions]
    r"""How to handle events when all receivers are exerting backpressure"""
...
class OutputDynatraceOtlpDynatraceOtlp1(BaseModel):
    protocol: TypeHTTPOption
    ...
    endpoint_type: Annotated[
        Annotated[Optional[EndpointType1], PlainValidator(validate_open_enum(False))],
        pydantic.Field(alias="endpointType"),
    ] = EndpointType1.SAAS
    r"""Select the type of Dynatrace endpoint configured"""
    ...
    def serialize_endpoint_type(self, value):
        if isinstance(value, str):
            try:
                return models.EndpointType1(value)
            except ValueError:
                return value
        return value
...
OutputDynatraceOtlpTypedDict = TypeAliasType(
...
OutputDynatraceOtlp = TypeAliasType(
    "OutputDynatraceOtlp",
    Union[
