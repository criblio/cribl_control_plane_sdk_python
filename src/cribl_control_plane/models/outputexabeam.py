...
class OutputExabeamType4(str, Enum):
    EXABEAM = "exabeam"


class OutputExabeamExabeam4TypedDict(TypedDict):
...
class OutputExabeamExabeam4(BaseModel):
    type: OutputExabeamType4
...
class OutputExabeamType3(str, Enum):
    EXABEAM = "exabeam"


class OutputExabeamExabeam3TypedDict(TypedDict):
...
class OutputExabeamExabeam3(BaseModel):
    type: OutputExabeamType3
...
class OutputExabeamType2(str, Enum):
    EXABEAM = "exabeam"


class OutputExabeamExabeam2TypedDict(TypedDict):
...
class OutputExabeamExabeam2(BaseModel):
    type: OutputExabeamType2
...
class OutputExabeamType1(str, Enum):
    EXABEAM = "exabeam"


class OutputExabeamExabeam1TypedDict(TypedDict):
...
class OutputExabeamExabeam1(BaseModel):
    type: OutputExabeamType1
...
OutputExabeamTypedDict = TypeAliasType(
