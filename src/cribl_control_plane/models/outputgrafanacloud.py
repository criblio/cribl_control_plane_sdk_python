...
from .prometheusauth1type import PrometheusAuth1Type, PrometheusAuth1TypeTypedDict
...
class OutputGrafanaCloudGrafanaCloud2TypedDict(TypedDict):
    ...
    prometheus_auth: NotRequired[PrometheusAuth1TypeTypedDict]
    loki_auth: NotRequired[PrometheusAuth1TypeTypedDict]
...
class OutputGrafanaCloudGrafanaCloud2(BaseModel):
    ...
    prometheus_auth: Annotated[
        Optional[PrometheusAuth1Type], pydantic.Field(alias="prometheusAuth")
    ] = None

    loki_auth: Annotated[
        Optional[PrometheusAuth1Type], pydantic.Field(alias="lokiAuth")
    ] = None
