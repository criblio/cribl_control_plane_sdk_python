...
class OutputKafkaKafka4TypedDict(TypedDict):
...
class OutputKafkaKafka4(BaseModel):
    type: TypeKafkaOption
...
class OutputKafkaKafka3TypedDict(TypedDict):
    type: TypeKafkaOption
    brokers: List[str]
    r"""Enter each Kafka bootstrap server you want to use. Specify hostname and port, e.g., mykafkabroker:9092, or just hostname, in which case @{product} will assign port 9092."""
    topic: str
...
class OutputKafkaKafka3(BaseModel):
    type: TypeKafkaOption
...
class OutputKafkaKafka2TypedDict(TypedDict):
    type: TypeKafkaOption
    brokers: List[str]
    r"""Enter each Kafka bootstrap server you want to use. Specify hostname and port, e.g., mykafkabroker:9092, or just hostname, in which case @{product} will assign port 9092."""
    topic: str
...
class OutputKafkaKafka2(BaseModel):
    type: TypeKafkaOption
...
class OutputKafkaKafka1TypedDict(TypedDict):
    type: TypeKafkaOption
    brokers: List[str]
    r"""Enter each Kafka bootstrap server you want to use. Specify hostname and port, e.g., mykafkabroker:9092, or just hostname, in which case @{product} will assign port 9092."""
    topic: str
...
class OutputKafkaKafka1(BaseModel):
    type: TypeKafkaOption
...
OutputKafkaTypedDict = TypeAliasType(
...
OutputKafka = TypeAliasType(
    "OutputKafka",
    Union[OutputKafkaKafka1, OutputKafkaKafka2, OutputKafkaKafka3, OutputKafkaKafka4],
)
