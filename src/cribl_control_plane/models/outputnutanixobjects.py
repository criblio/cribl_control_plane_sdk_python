...
class OutputNutanixObjectsAuthenticationMethod(str, Enum, metaclass=utils.OpenEnumMeta):
...
class OutputNutanixObjectsTypedDict(TypedDict):
    ...
    aws_authentication_method: NotRequired[OutputNutanixObjectsAuthenticationMethod]
    r"""AWS authentication method."""
...
class OutputNutanixObjects(BaseModel):
    ...
    aws_authentication_method: Annotated[
        Optional[OutputNutanixObjectsAuthenticationMethod],
    ...
    def serialize_aws_authentication_method(self, value):
        if isinstance(value, str):
            try:
                return models.OutputNutanixObjectsAuthenticationMethod(value)
            except ValueError:
                return value
        return value
