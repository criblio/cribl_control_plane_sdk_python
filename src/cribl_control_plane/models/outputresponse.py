...
from .outputresponse_outputgraphite_type import (
    ...
    OutputResponseOutputCriblMetrics,
    OutputResponseOutputCriblMetricsTypedDict,
...
from .outputresponse_outputwebhook_authentication_type_1 import (
...
_OUTPUT_RESPONSE_VARIANTS: dict[str, Any] = {
    ...
    "cribl_metrics": OutputResponseOutputCriblMetrics,
