...
from .outputresponse_pqcontrols_graphite import (
    OutputResponsePqControlsGraphite,
    OutputResponsePqControlsGraphiteTypedDict,
...
class OutputResponseGoogleAuthenticationMethodGoogleCloudObservability(
    str, Enum, metaclass=utils.OpenEnumMeta
):
...
class OutputResponseOutputGoogleCloudObservabilityTypedDict(TypedDict):
    ...
    google_auth_method: OutputResponseGoogleAuthenticationMethodGoogleCloudObservability
    r"""Choose Auto to use Google Application Default Credentials (ADC). Choose Secret to select or create a stored secret that references Google service account credentials."""
    id: NotRequired[str]
    r"""Unique ID for this output"""
    pipeline: NotRequired[str]
...
class OutputResponseOutputGoogleCloudObservability(BaseModel):
    ...
    def serialize_google_auth_method(self, value):
        if isinstance(value, str):
            try:
                return models.OutputResponseGoogleAuthenticationMethodGoogleCloudObservability(
                    value
                )
            except ValueError:
                return value
...
class OutputResponseTypeGoogleBigquery(str, Enum):
    GOOGLE_BIGQUERY = "google_bigquery"


class OutputResponseGoogleAuthenticationMethodGoogleBigquery(
    str, Enum, metaclass=utils.OpenEnumMeta
):
...
class OutputResponsePqControlsGoogleBigqueryTypedDict(TypedDict):
    pass


class OutputResponsePqControlsGoogleBigquery(BaseModel):
    pass


class OutputResponseOutputGoogleBigqueryTypedDict(TypedDict):
    type: OutputResponseTypeGoogleBigquery
    project_id: str
    ...
    table_id: str
    r"""BigQuery table ID"""
    google_auth_method: OutputResponseGoogleAuthenticationMethodGoogleBigquery
    r"""Choose Auto to use Google Application Default Credentials (ADC), or Secret to select or create a stored secret that references Google service account credentials"""
    id: NotRequired[str]
    r"""Unique ID for this output"""
    pipeline: NotRequired[str]
    ...
    pq_max_buffer_size_bytes: NotRequired[str]
    r"""The maximum size to hold in memory before writing events to disk. Enter a numeral with units of KB, MB, etc. The minimum value is 64KB and the maximum value is 10MB."""
    pq_controls: NotRequired[OutputResponsePqControlsGoogleBigqueryTypedDict]
    template_streamtags: NotRequired[str]
    r"""Binds 'streamtags' to a variable for dynamic value resolution. Set to variable ID (pack-scoped) or 'cribl.'/'edge.' prefixed ID (group-scoped). Variable value overrides 'streamtags' at runtime."""
...
class OutputResponseOutputGoogleBigquery(BaseModel):
    type: OutputResponseTypeGoogleBigquery
    ...
    pq_controls: Annotated[
        Optional[OutputResponsePqControlsGoogleBigquery],
        pydantic.Field(alias="pqControls"),
    ] = None
    ...
    def serialize_google_auth_method(self, value):
        if isinstance(value, str):
            try:
                return models.OutputResponseGoogleAuthenticationMethodGoogleBigquery(
                    value
                )
            except ValueError:
                return value
...
try:
    ...
    pass
try:
    OutputResponseOutputGoogleBigquery.model_rebuild()
except NameError:
    pass
try:
