...
class OutputScalityS3SignatureVersion(str, Enum, metaclass=utils.OpenEnumMeta):
...
class OutputScalityS3TypedDict(TypedDict):
    ...
    signature_version: NotRequired[OutputScalityS3SignatureVersion]
    r"""Signature version to use for signing Scality requests"""
...
class OutputScalityS3(BaseModel):
    ...
    signature_version: Annotated[
        Optional[OutputScalityS3SignatureVersion],
    ...
    def serialize_signature_version(self, value):
        if isinstance(value, str):
            try:
                return models.OutputScalityS3SignatureVersion(value)
            except ValueError:
                return value
        return value
