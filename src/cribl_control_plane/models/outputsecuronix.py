...
class OutputSecuronixType(str, Enum):
    r"""Connector type identifier."""

    SECURONIX = "securonix"


class OutputSecuronixAuthenticationType(str, Enum, metaclass=utils.OpenEnumMeta):
...
class OutputSecuronixPqControlsTypedDict(TypedDict):
    r"""Persistent queue controls."""


class OutputSecuronixPqControls(BaseModel):
    r"""Persistent queue controls."""


class OutputSecuronixTypedDict(TypedDict):
    type: OutputSecuronixType
    r"""Connector type identifier."""
    http_receiver_endpoint: str
    r"""URL of the Securonix HTTP Event Receiver endpoint"""
    id: NotRequired[str]
    ...
    auth_type: NotRequired[OutputSecuronixAuthenticationType]
    r"""Authentication method to use for the HTTP request"""
    ...
    pq_controls: NotRequired[OutputSecuronixPqControlsTypedDict]
    r"""Persistent queue controls."""
    ...
    template_http_receiver_endpoint: NotRequired[str]
    r"""Binds 'httpReceiverEndpoint' to a variable for dynamic value resolution. Set to variable ID (pack-scoped) or 'cribl.'/'edge.' prefixed ID (group-scoped). Variable value overrides 'httpReceiverEndpoint' at runtime."""


class OutputSecuronix(BaseModel):
    type: OutputSecuronixType
    r"""Connector type identifier."""

    http_receiver_endpoint: Annotated[str, pydantic.Field(alias="httpReceiverEndpoint")]
    r"""URL of the Securonix HTTP Event Receiver endpoint"""
    ...
    auth_type: Annotated[
        Optional[OutputSecuronixAuthenticationType], pydantic.Field(alias="authType")
    ] = None
    r"""Authentication method to use for the HTTP request"""
    ...
    pq_controls: Annotated[
        Optional[OutputSecuronixPqControls], pydantic.Field(alias="pqControls")
    ] = None
    r"""Persistent queue controls."""
    ...
    template_http_receiver_endpoint: Annotated[
        Optional[str], pydantic.Field(alias="__template_httpReceiverEndpoint")
    ] = None
    r"""Binds 'httpReceiverEndpoint' to a variable for dynamic value resolution. Set to variable ID (pack-scoped) or 'cribl.'/'edge.' prefixed ID (group-scoped). Variable value overrides 'httpReceiverEndpoint' at runtime."""
    ...
    def serialize_auth_type(self, value):
        if isinstance(value, str):
            try:
                return models.OutputSecuronixAuthenticationType(value)
            except ValueError:
                return value
        return value
    ...
    def serialize_model(self, handler):
        optional_fields = set(
            [
                ...
                "__template_httpReceiverEndpoint",
            ]
        )
