...
class OutputSnsType5(str, Enum):
    SNS = "sns"


class OutputSnsSns5TypedDict(TypedDict):
    type: OutputSnsType5
    topic_arn: str
...
class OutputSnsType4(str, Enum):
    SNS = "sns"


class OutputSnsSns4TypedDict(TypedDict):
    type: OutputSnsType4
    topic_arn: str
    r"""The ARN of the SNS topic to send events to. When a non-AWS URL is specified, format must be: '{url}/myQueueName'. E.g., 'https://host:port/myQueueName'. Must be a JavaScript expression (which can evaluate to a constant value), enclosed in quotes or backticks. Can be evaluated only at initialization time. Example referencing a Global Variable: `https://host:port/myQueue-${C.vars.myVar}`"""
    message_group_id: str
...
class OutputSnsType3(str, Enum):
    SNS = "sns"


class OutputSnsSns3TypedDict(TypedDict):
    type: OutputSnsType3
    topic_arn: str
    r"""The ARN of the SNS topic to send events to. When a non-AWS URL is specified, format must be: '{url}/myQueueName'. E.g., 'https://host:port/myQueueName'. Must be a JavaScript expression (which can evaluate to a constant value), enclosed in quotes or backticks. Can be evaluated only at initialization time. Example referencing a Global Variable: `https://host:port/myQueue-${C.vars.myVar}`"""
    message_group_id: str
...
class OutputSnsType2(str, Enum):
    SNS = "sns"


class OutputSnsSns2TypedDict(TypedDict):
    type: OutputSnsType2
    topic_arn: str
    r"""The ARN of the SNS topic to send events to. When a non-AWS URL is specified, format must be: '{url}/myQueueName'. E.g., 'https://host:port/myQueueName'. Must be a JavaScript expression (which can evaluate to a constant value), enclosed in quotes or backticks. Can be evaluated only at initialization time. Example referencing a Global Variable: `https://host:port/myQueue-${C.vars.myVar}`"""
    message_group_id: str
...
class OutputSnsType1(str, Enum):
    SNS = "sns"


class OutputSnsSns1TypedDict(TypedDict):
    type: OutputSnsType1
    topic_arn: str
    r"""The ARN of the SNS topic to send events to. When a non-AWS URL is specified, format must be: '{url}/myQueueName'. E.g., 'https://host:port/myQueueName'. Must be a JavaScript expression (which can evaluate to a constant value), enclosed in quotes or backticks. Can be evaluated only at initialization time. Example referencing a Global Variable: `https://host:port/myQueue-${C.vars.myVar}`"""
    message_group_id: str
...
OutputSnsTypedDict = TypeAliasType(
    "OutputSnsTypedDict",
    Union[
...
OutputSns = TypeAliasType(
    "OutputSns",
    Union[OutputSnsSns1, OutputSnsSns2, OutputSnsSns3, OutputSnsSns4, OutputSnsSns5],
)
