...
class OutputStorjS3AuthenticationMethod(str, Enum, metaclass=utils.OpenEnumMeta):
    # Manual
    MANUAL = "manual"
    # Secret Key pair
    SECRET = "secret"
...
class OutputStorjS3SignatureVersion(str, Enum, metaclass=utils.OpenEnumMeta):
...
class OutputStorjS3TypedDict(TypedDict):
    ...
    aws_authentication_method: NotRequired[OutputStorjS3AuthenticationMethod]
    signature_version: NotRequired[OutputStorjS3SignatureVersion]
    r"""Signature version to use for signing Storj requests"""
...
class OutputStorjS3(BaseModel):
    ...
    aws_authentication_method: Annotated[
        Optional[OutputStorjS3AuthenticationMethod],
        pydantic.Field(alias="awsAuthenticationMethod"),
    ] = None

    signature_version: Annotated[
        Optional[OutputStorjS3SignatureVersion],
    ...
    def serialize_aws_authentication_method(self, value):
        if isinstance(value, str):
            try:
                return models.OutputStorjS3AuthenticationMethod(value)
            except ValueError:
                return value
        return value
    ...
    def serialize_signature_version(self, value):
        if isinstance(value, str):
            try:
                return models.OutputStorjS3SignatureVersion(value)
            except ValueError:
                return value
        return value
