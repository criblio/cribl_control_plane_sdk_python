...
class OutputSumoLogicType2(str, Enum):
    SUMO_LOGIC = "sumo_logic"


class OutputSumoLogicSumoLogic2TypedDict(TypedDict):
...
class OutputSumoLogicSumoLogic2(BaseModel):
    type: OutputSumoLogicType2
...
class OutputSumoLogicType1(str, Enum):
    SUMO_LOGIC = "sumo_logic"


class OutputSumoLogicSumoLogic1TypedDict(TypedDict):
...
class OutputSumoLogicSumoLogic1(BaseModel):
    type: OutputSumoLogicType1
...
OutputSumoLogicTypedDict = TypeAliasType(
    "OutputSumoLogicTypedDict",
    Union[OutputSumoLogicSumoLogic1TypedDict, OutputSumoLogicSumoLogic2TypedDict],
)


OutputSumoLogic = TypeAliasType(
    "OutputSumoLogic", Union[OutputSumoLogicSumoLogic1, OutputSumoLogicSumoLogic2]
)
