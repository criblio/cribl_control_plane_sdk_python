...
class OutputTcpjsonTcpjson6TypedDict(TypedDict):
...
class OutputTcpjsonTcpjson6(BaseModel):
    type: TypeTcpjsonOption
...
class OutputTcpjsonTcpjson5TypedDict(TypedDict):
    type: TypeTcpjsonOption
    auth_type: NotRequired[AuthType2Options]
    r"""Enter credentials directly, or select a stored secret"""
    id: NotRequired[str]
...
class OutputTcpjsonTcpjson5(BaseModel):
    type: TypeTcpjsonOption
...
class OutputTcpjsonTcpjson4TypedDict(TypedDict):
    type: TypeTcpjsonOption
...
class OutputTcpjsonTcpjson4(BaseModel):
    type: TypeTcpjsonOption
...
class OutputTcpjsonTcpjson3TypedDict(TypedDict):
    type: TypeTcpjsonOption
    on_backpressure: NotRequired[OnBackpressureOptions]
    r"""How to handle events when all receivers are exerting backpressure"""
    id: NotRequired[str]
...
class OutputTcpjsonTcpjson3(BaseModel):
    type: TypeTcpjsonOption
...
class OutputTcpjsonTcpjson2TypedDict(TypedDict):
    type: TypeTcpjsonOption
...
class OutputTcpjsonTcpjson2(BaseModel):
    type: TypeTcpjsonOption
...
class OutputTcpjsonTcpjson1TypedDict(TypedDict):
    type: TypeTcpjsonOption
    host: str
    r"""The hostname of the receiver"""
    port: float
...
class OutputTcpjsonTcpjson1(BaseModel):
    type: TypeTcpjsonOption
...
OutputTcpjsonTypedDict = TypeAliasType(
