...
class OutputTraversalOtlpType(str, Enum):
    r"""Connector type identifier."""

    TRAVERSAL_OTLP = "traversal_otlp"


class OutputTraversalOtlpAuthenticationType(str, Enum, metaclass=utils.OpenEnumMeta):
...
class OutputTraversalOtlpPqControlsTypedDict(TypedDict):
    r"""Persistent queue controls."""


class OutputTraversalOtlpPqControls(BaseModel):
    r"""Persistent queue controls."""


class OutputTraversalOtlpTypedDict(TypedDict):
    type: OutputTraversalOtlpType
    r"""Connector type identifier."""
    endpoint: str
    r"""The endpoint where OTel log events will be sent. Enter any valid URL or an IP address (IPv4 or IPv6; enclose IPv6 addresses in square brackets)."""
    id: NotRequired[str]
    ...
    auth_type: NotRequired[OutputTraversalOtlpAuthenticationType]
    r"""Authentication type"""
    ...
    pq_controls: NotRequired[OutputTraversalOtlpPqControlsTypedDict]
    r"""Persistent queue controls."""
...
class OutputTraversalOtlp(BaseModel):
    type: OutputTraversalOtlpType
    r"""Connector type identifier."""
    ...
    auth_type: Annotated[
        Optional[OutputTraversalOtlpAuthenticationType],
    ...
    pq_controls: Annotated[
        Optional[OutputTraversalOtlpPqControls], pydantic.Field(alias="pqControls")
    ] = None
    r"""Persistent queue controls."""
    ...
    def serialize_auth_type(self, value):
        if isinstance(value, str):
            try:
                return models.OutputTraversalOtlpAuthenticationType(value)
            except ValueError:
                return value
        return value
...
try:
    OutputTraversalOtlp.model_rebuild()
except NameError:
    pass
