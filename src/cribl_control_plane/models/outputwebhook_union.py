...
class OutputWebhookAuthenticationType2(str, Enum, metaclass=utils.OpenEnumMeta):
...
class OutputWebhookURL2(BaseModel):
    url: str
    r"""URL of a webhook endpoint to send events to, such as http://localhost:10200"""
...
class OutputWebhookWebhook2(BaseModel):
    ...
    format_: Annotated[
        Optional[OutputWebhookFormat2], pydantic.Field(alias="format")
    ] = None
    r"""How to format events before sending out"""
    ...
    auth_type: Annotated[
        Optional[OutputWebhookAuthenticationType2], pydantic.Field(alias="authType")
    ] = None
    r"""Authentication method to use for the HTTP request"""
    ...
    def serialize_auth_type(self, value):
        if isinstance(value, str):
            try:
                return models.OutputWebhookAuthenticationType2(value)
            except ValueError:
                return value
        return value
...
class OutputWebhookAuthenticationType1(str, Enum, metaclass=utils.OpenEnumMeta):
    r"""Authentication method to use for the HTTP request"""
...
class OutputWebhookURL1(BaseModel):
    url: str
    r"""URL of a webhook endpoint to send events to, such as http://localhost:10200"""
...
class OutputWebhookWebhook1(BaseModel):
    ...
    format_: Annotated[
        Optional[OutputWebhookFormat1], pydantic.Field(alias="format")
    ] = None
    r"""How to format events before sending out"""
    ...
    auth_type: Annotated[
        Optional[OutputWebhookAuthenticationType1], pydantic.Field(alias="authType")
    ] = None
    r"""Authentication method to use for the HTTP request"""
    ...
    def serialize_auth_type(self, value):
        if isinstance(value, str):
            try:
                return models.OutputWebhookAuthenticationType1(value)
            except ValueError:
                return value
        return value
...
OutputWebhookUnionTypedDict = TypeAliasType(
    "OutputWebhookUnionTypedDict",
    Union[OutputWebhookWebhook1TypedDict, OutputWebhookWebhook2TypedDict],
)


OutputWebhookUnion = TypeAliasType(
    "OutputWebhookUnion", Union[OutputWebhookWebhook1, OutputWebhookWebhook2]
)


try:
    OutputWebhookURL2.model_rebuild()
except NameError:
    pass
try:
    OutputWebhookWebhook2.model_rebuild()
except NameError:
    pass
try:
    OutputWebhookURL1.model_rebuild()
except NameError:
    pass
try:
    OutputWebhookWebhook1.model_rebuild()
except NameError:
    pass
