...
class PaginatedDistributedSummaryTypedDict(TypedDict):
    items: List[DistributedSummaryTypedDict]
...
class PaginatedDistributedSummary(BaseModel):
    items: List[DistributedSummary]
    r"""The pre-limited items in the list of results"""
...
try:
    PaginatedDistributedSummary.model_rebuild()
except NameError:
    pass
