...
class PaginatedGitLogResultTypedDict(TypedDict):
    items: List[GitLogResultTypedDict]
...
class PaginatedGitLogResult(BaseModel):
    items: List[GitLogResult]
    r"""The items returned in this response, after any offset/limit pagination has been applied."""
...
try:
    PaginatedGitLogResult.model_rebuild()
except NameError:
    pass
