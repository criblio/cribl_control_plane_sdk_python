...
from .functionconfschemalocalsearchtimerangenormalizer import (
    FunctionConfSchemaLocalSearchTimeRangeNormalizer,
    FunctionConfSchemaLocalSearchTimeRangeNormalizerTypedDict,
)
...
try:
    PipelineFunctionLocalSearchTimeRangeNormalizer.model_rebuild()
except NameError:
    pass
