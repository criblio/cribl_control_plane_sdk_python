...
from .matchtypeoptionslookupdblookupfalsematchmodecidr import (
...
class LookupDbLookupFalseMatchModeRegexMatchMode(
    str, Enum, metaclass=utils.OpenEnumMeta
):
    r"""Specifies the matching method based on the format and logic used in the lookup file"""
...
class LookupDbLookupFalseMatchModeRegexInFieldTypedDict(TypedDict):
    event_field: str
    r"""Field name as it appears in events"""
    lookup_field: NotRequired[str]
    r"""Optional: The field name as it appears in the lookup file. Defaults to event field name"""
...
class LookupDbLookupFalseMatchModeRegexInField(BaseModel):
    event_field: Annotated[str, pydantic.Field(alias="eventField")]
    r"""Field name as it appears in events"""
...
class LookupDbLookupFalseMatchModeRegexOutFieldTypedDict(TypedDict):
    lookup_field: str
    r"""The field name as it appears in the lookup file"""
    event_field: NotRequired[str]
    r"""Optional: Field name to add to event. Defaults to lookup field name."""
...
class LookupDbLookupFalseMatchModeRegexOutField(BaseModel):
    lookup_field: Annotated[str, pydantic.Field(alias="lookupField")]
    r"""The field name as it appears in the lookup file"""
...
class LookupDbLookupFalseMatchModeRegexTypedDict(TypedDict):
    file: str
    r"""Path to the lookup file. Reference environment variables via $. Example: $HOME/file.csv"""
    match_mode: NotRequired[LookupDbLookupFalseMatchModeRegexMatchMode]
    r"""Specifies the matching method based on the format and logic used in the lookup file"""
    match_type: NotRequired[MatchTypeOptionsLookupDbLookupFalseMatchModeCidr]
    ...
    reload_period_sec: NotRequired[float]
    r"""Checks the lookup file periodically for changes and reloads it if modified. Set to -1 to disable reloading (default). Useful for lookups not managed by Stream or not updated by an external process. [Learn more](https://docs.cribl.io/stream/lookup-function/#advanced-settings)"""
    in_fields: NotRequired[List[LookupDbLookupFalseMatchModeRegexInFieldTypedDict]]
    r"""Fields that should be used to key into the lookup table"""
    out_fields: NotRequired[List[LookupDbLookupFalseMatchModeRegexOutFieldTypedDict]]
    r"""Fields to add to events after matching lookup. Defaults to all if not specified."""
    add_to_event: NotRequired[bool]
    r"""Add the looked-up values to _raw, as key=value pairs"""


class LookupDbLookupFalseMatchModeRegex(BaseModel):
    file: str
    r"""Path to the lookup file. Reference environment variables via $. Example: $HOME/file.csv"""

    match_mode: Annotated[
        Optional[LookupDbLookupFalseMatchModeRegexMatchMode],
        pydantic.Field(alias="matchMode"),
    ] = None
    r"""Specifies the matching method based on the format and logic used in the lookup file"""

    match_type: Annotated[
        Optional[MatchTypeOptionsLookupDbLookupFalseMatchModeCidr],
    ...
    in_fields: Annotated[
        Optional[List[LookupDbLookupFalseMatchModeRegexInField]],
        pydantic.Field(alias="inFields"),
    ] = None
    r"""Fields that should be used to key into the lookup table"""

    out_fields: Annotated[
        Optional[List[LookupDbLookupFalseMatchModeRegexOutField]],
        pydantic.Field(alias="outFields"),
    ] = None
    r"""Fields to add to events after matching lookup. Defaults to all if not specified."""
    ...
    def serialize_match_mode(self, value):
        if isinstance(value, str):
            try:
                return models.LookupDbLookupFalseMatchModeRegexMatchMode(value)
            except ValueError:
                return value
        return value
    ...
    def serialize_match_type(self, value):
        if isinstance(value, str):
            try:
                return models.MatchTypeOptionsLookupDbLookupFalseMatchModeCidr(value)
            except ValueError:
                return value
        return value
...
LookupDbLookupFalseTypedDict = TypeAliasType(
    ...
    Union[
        ...
        LookupDbLookupFalseMatchModeRegexTypedDict,
    ],
)
...
_LOOKUP_DB_LOOKUP_FALSE_VARIANTS: dict[str, Any] = {
    ...
    "regex": LookupDbLookupFalseMatchModeRegex,
...
try:
    ...
    pass
try:
    LookupDbLookupFalseMatchModeRegexInField.model_rebuild()
except NameError:
    pass
try:
    LookupDbLookupFalseMatchModeRegexOutField.model_rebuild()
except NameError:
    pass
try:
    LookupDbLookupFalseMatchModeRegex.model_rebuild()
except NameError:
    pass
try:
