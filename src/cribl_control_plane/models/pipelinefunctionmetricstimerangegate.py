...
from .functionconfschemametricstimerangegate import (
    ...
    FunctionConfSchemaMetricsTimeRangeGateTypedDict,
)
...
class PipelineFunctionMetricsTimeRangeGateID(str, Enum):
    r"""Identifier of the Function. Always <code>metrics_time_range_gate</code>"""

    METRICS_TIME_RANGE_GATE = "metrics_time_range_gate"


class PipelineFunctionMetricsTimeRangeGateTypedDict(TypedDict):
    id: PipelineFunctionMetricsTimeRangeGateID
    r"""Identifier of the Function. Always <code>metrics_time_range_gate</code>"""
...
class PipelineFunctionMetricsTimeRangeGate(BaseModel):
    id: PipelineFunctionMetricsTimeRangeGateID
    r"""Identifier of the Function. Always <code>metrics_time_range_gate</code>"""

    conf: FunctionConfSchemaMetricsTimeRangeGate
...
try:
    PipelineFunctionMetricsTimeRangeGate.model_rebuild()
except NameError:
    pass
