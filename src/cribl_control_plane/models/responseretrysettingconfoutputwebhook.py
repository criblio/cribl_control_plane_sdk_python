...
class ResponseRetrySettingConfOutputWebhookTypedDict(TypedDict):
    http_status: float
...
class ResponseRetrySettingConfOutputWebhook(BaseModel):
...
try:
    ResponseRetrySettingConfOutputWebhook.model_rebuild()
except NameError:
    pass
