...
class RetryType(str, Enum, metaclass=utils.OpenEnumMeta):
...
class RetryRulesType(BaseModel):
    type: Annotated[Optional[RetryType], PlainValidator(validate_open_enum(False))] = (
        RetryType.BACKOFF
    )
    r"""The algorithm to use when performing HTTP retries"""
