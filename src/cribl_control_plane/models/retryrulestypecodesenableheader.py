...
class RetryRulesTypeCodesEnableHeaderTypedDict(TypedDict):
...
class RetryRulesTypeCodesEnableHeader(BaseModel):
    type: RetryTypeOptionsHealthCheckCollectorConfRetryRules
    r"""The algorithm to use when performing HTTP retries"""
...
try:
    RetryRulesTypeCodesEnableHeader.model_rebuild()
except NameError:
    pass
