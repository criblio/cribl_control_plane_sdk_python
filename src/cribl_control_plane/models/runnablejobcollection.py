...
from .collectortype import CollectorType, CollectorTypeTypedDict
from .inputtype import InputType, InputTypeTypedDict
...
class RunnableJobCollectionTypedDict(TypedDict):
    collector: CollectorTypeTypedDict
    ...
    input: NotRequired[InputTypeTypedDict]
