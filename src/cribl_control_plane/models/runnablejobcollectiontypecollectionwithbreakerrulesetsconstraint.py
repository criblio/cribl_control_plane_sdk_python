...
class RunnableJobCollectionTypeCollectionWithBreakerRulesetsConstraintType(
    str, Enum, metaclass=utils.OpenEnumMeta
):
    COLLECTION = "collection"


class RunnableJobCollectionTypeCollectionWithBreakerRulesetsConstraintTypedDict(
    TypedDict
):
    type: NotRequired[
...
class RunnableJobCollectionTypeCollectionWithBreakerRulesetsConstraint(BaseModel):
    type: Optional[
        RunnableJobCollectionTypeCollectionWithBreakerRulesetsConstraintType
    ] = None
    ...
    def serialize_type(self, value):
        if isinstance(value, str):
            try:
                return models.RunnableJobCollectionTypeCollectionWithBreakerRulesetsConstraintType(
                    value
                )
            except ValueError:
                return value
...
try:
    RunnableJobCollectionTypeCollectionWithBreakerRulesetsConstraint.model_rebuild()
except NameError:
    pass
