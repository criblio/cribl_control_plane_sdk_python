...
class SystemSettingsConfUpdateTypedDict(TypedDict):
    api: NotRequired[APITypeSystemSettingsConfTypedDict]
    ...
    system: NotRequired[SystemTypeSystemSettingsConfTypedDict]
...
class SystemSettingsConfUpdate(BaseModel):
    api: Optional[APITypeSystemSettingsConf] = None
    r"""API server configuration for the Cribl instance."""
    ...
    system: Optional[SystemTypeSystemSettingsConf] = None
    r"""System-level operational settings for the Cribl instance."""
