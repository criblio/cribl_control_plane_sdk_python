...
class Tls1TypeMinimumTLSVersion(str, Enum, metaclass=utils.OpenEnumMeta):
    TL_SV1 = "TLSv1"
    TL_SV1_1 = "TLSv1.1"
    TL_SV1_2 = "TLSv1.2"
    TL_SV1_3 = "TLSv1.3"
...
class Tls1TypeMaximumTLSVersion(str, Enum, metaclass=utils.OpenEnumMeta):
    TL_SV1 = "TLSv1"
    TL_SV1_1 = "TLSv1.1"
    TL_SV1_2 = "TLSv1.2"
    TL_SV1_3 = "TLSv1.3"
...
class Tls1TypeTypedDict(TypedDict):
    ...
    min_version: NotRequired[Tls1TypeMinimumTLSVersion]
    max_version: NotRequired[Tls1TypeMaximumTLSVersion]


class Tls1Type(BaseModel):
    ...
    min_version: Annotated[
        Annotated[
            Optional[Tls1TypeMinimumTLSVersion],
    ...
    max_version: Annotated[
        Annotated[
            Optional[Tls1TypeMaximumTLSVersion],
            PlainValidator(validate_open_enum(False)),
        ],
    ...
    def serialize_min_version(self, value):
        if isinstance(value, str):
            try:
                return models.Tls1TypeMinimumTLSVersion(value)
            except ValueError:
                return value
        return value
    ...
    def serialize_max_version(self, value):
        if isinstance(value, str):
            try:
                return models.Tls1TypeMaximumTLSVersion(value)
            except ValueError:
                return value
        return value
