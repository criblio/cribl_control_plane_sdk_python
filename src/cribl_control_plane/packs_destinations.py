...
from cribl_control_plane.packs_destinations_statuses import PacksDestinationsStatuses
...
class PacksDestinations(BaseSDK):
    ...
    def _init_sdks(self):
        ...
        self.statuses = PacksDestinationsStatuses(
            self.sdk_configuration, parent_ref=self.parent_ref
        )
    ...
    def list(
        ...
        *,
    ...
    ) -> Optional[models.GetOutputSystemByPackResponse]:
        ...
        def next_func() -> Optional[models.GetOutputSystemByPackResponse]:
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.GetOutputSystemByPackResponse(
                result=unmarshal_json_response(
                    models.GetOutputSystemByPackResponseBody, http_res
                ),
                next=next_func,
            )
    ...
    async def list_async(
        ...
        *,
        ...
        def next_func() -> Awaitable[Optional[models.GetOutputSystemByPackResponse]]:
            body = utils.unmarshal_json(http_res.text, Union[Dict[Any, Any], List[Any]])
