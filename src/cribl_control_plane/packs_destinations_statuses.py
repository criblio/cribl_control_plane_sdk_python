...
class PacksDestinationsStatuses(BaseSDK):
    def list(
        self,
        *,
        pack: str,
    ...
    ) -> Optional[models.GetOutputStatusSystemOutputsByPackResponse]:
        r"""List the status of all Destinations within a Pack
        ...
        request = models.GetOutputStatusSystemOutputsByPackRequest(
            metrics=metrics,
            type=type_,
            offset=offset,
            limit=limit,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="getOutputStatusSystemOutputsByPack",
                oauth2_scopes=[],
        ...
        def next_func() -> Optional[models.GetOutputStatusSystemOutputsByPackResponse]:
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.GetOutputStatusSystemOutputsByPackResponse(
                result=unmarshal_json_response(
                    models.GetOutputStatusSystemOutputsByPackResponseBody, http_res
                ),
                next=next_func,
            )
    ...
    async def list_async(
        ...
        *,
        ...
        def next_func() -> (
            Awaitable[Optional[models.GetOutputStatusSystemOutputsByPackResponse]]
        ):
            body = utils.unmarshal_json(http_res.text, Union[Dict[Any, Any], List[Any]])
    ...
    def get(
        ...
        *,
        ...
        r"""Get the status of a Destination within a Pack

        Get the status and optional metrics for the specified Destination within the specified Pack.

        :param id: The <code>id</code> of the Destination to get the status for.
        :param pack: The <code>id</code> of the Pack.
        :param metrics: Set to <code>true</code> to include metrics for each Destination. Otherwise, <code>false</code> (default).
        :param type: Set to <code>true</code> to prefix the Destination <code>id</code> with the Destination type. Otherwise, <code>false</code> (default).
        :param retries: Override the default retry configuration for this method
        ...
        request = models.GetOutputStatusSystemOutputsByPackAndIDRequest(
            id=id,
            metrics=metrics,
            type=type_,
            pack=pack,
        ...
        req = self._build_request(
            method="GET",
            path="/p/{pack}/system/status/outputs/{id}",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="getOutputStatusSystemOutputsByPackAndId",
                oauth2_scopes=[],
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
