...
class RoutesSDK(BaseSDK):
    ...
    def list(
        ...
        *,
    ...
    ) -> Optional[models.GetRoutesResponse]:
        r"""List all Routes
        ...
        request = models.GetRoutesRequest(
            offset=offset,
            limit=limit,
        )
        ...
        def next_func() -> Optional[models.GetRoutesResponse]:
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.GetRoutesResponse(
    ...
    async def list_async(
        ...
        *,
        ...
        def next_func() -> Awaitable[Optional[models.GetRoutesResponse]]:
            body = utils.unmarshal_json(http_res.text, Union[Dict[Any, Any], List[Any]])
