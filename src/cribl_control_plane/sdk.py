...
class CriblControlPlane(BaseSDK):
    ...
    Optional scope: constructor ``group_id`` / ``node_id``, ``with_group`` / ``with_node``, or ``scoped()``.
    ...
    def __init__(
        ...
        :param group_id: Default /m/{group_id} base path
        :param node_id: Default /w/{node_id} base path
        """
    ...
    def with_group(self, group_id: str) -> "CriblControlPlane":
        """Clone client settings with default group scope (/m/{group_id})."""
        return CriblControlPlane(
            server_url=self.sdk_configuration.server_url,
            security=self.sdk_configuration.security,
            client=self.sdk_configuration.client,
            async_client=self.sdk_configuration.async_client,
            retry_config=self.sdk_configuration.retry_config,
            timeout_ms=self.sdk_configuration.timeout_ms,
            debug_logger=self.sdk_configuration.debug_logger,
            group_id=group_id,
            node_id=None,
        )

    def with_node(self, node_id: str) -> "CriblControlPlane":
        """Clone client settings with default worker-node scope (/w/{node_id})."""
        return CriblControlPlane(
            server_url=self.sdk_configuration.server_url,
            security=self.sdk_configuration.security,
            client=self.sdk_configuration.client,
