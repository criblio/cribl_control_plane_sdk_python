...
class SourcesStatuses(BaseSDK):
    ...
    def list(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> Optional[models.GetInputStatusResponse]:
        ...
        request = models.GetInputStatusRequest(
            metrics=metrics,
            type=type_,
            offset=offset,
            limit=limit,
        ...
        def next_func() -> Optional[models.GetInputStatusResponse]:
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return models.GetInputStatusResponse(
    ...
    async def list_async(
        ...
        *,
        ...
        def next_func() -> Awaitable[Optional[models.GetInputStatusResponse]]:
            body = utils.unmarshal_json(http_res.text, Union[Dict[Any, Any], List[Any]])
